            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    <div class="widget-header block-header">
                        ...
                        <p>A example of cake order form with validation</p>
                    </div>
                    <div class="widget-container">
                        <div class="widget-content">
                            <form action="http://lab.westilian.com/westilo-admin/material-style-sidebar/php/demo.php" method="post" class="j-forms" id="order-forms" novalidate>

                                <div class="form-content">

                                    <div class="w-section-header"><h3>Make your cake!</h3></div>
                                    ...
                                    <div class="unit filling">
                                        ...
                                        <label class="input multiple-select">
                                            <select autocomplete="off" name="filling[]" multiple="" class="form-control">
                                    ...
                                    <div class="unit lovely-things">
                                        ...
                                        <label class="checkbox">
                                            <input class="form-control" type="checkbox" name="candles" value="candles-5$" data-price="5">
                                            <i></i>
                                            Include candles + $5.00
                                        </label>
                                        <label class="checkbox">
                                            <input class="form-control" type="checkbox" name="show-inscription" value="inscription-20$" data-price="20" id="show-inscription">
                                            <i></i>
                                            Include inscription + $20.00
                                        </label>
                                        <div class="input hidden" id="inscription">
                                            <input class="form-control" type="text" placeholder="enter inscription" name="inscription">
                                        </div>
                                    </div>
                                    ...
                                    <div class="unit delivery" id="delivery">
                                        ...
                                        <label class="input select">
                                            <select autocomplete="off" name="delivery" class="form-control" >
                                    ...
                                    <div class="w-section-header"><h3>Contact Details</h3></div>
...
<script src="js/lib/j-forms-order.js"></script>
<!--[if lt IE 10]>
