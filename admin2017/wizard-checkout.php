                    ...
                    <div class="dropdown-menu notifications-tabs">
                        <div>
                            <ul class="nav material-tabs nav-tabs" role="tablist">
                                <li class="active"><a href="#message-notifications" aria-controls="message" role="tab" data-toggle="tab">Message</a></li>
                                <li><a href="#notifications" aria-controls="notifications" role="tab" data-toggle="tab">Notifications</a></li>
                            </ul>
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="message-notifications">
...
<section class="main-container">
    ...
    <div class="page-header filled full-block light">
        <div class="row">
            <div class="col-md-6">
                <h2>Checkout Form Wizard</h2>
                <p>Stepy checkout form wizard</p>
            </div>
            <div class="col-md-6">
                <ul class="list-page-breadcrumb">
                    <li><a href="#">Home <i class="zmdi zmdi-chevron-right"></i></a></li>
                    <li><a href="#">Layout <i class="zmdi zmdi-chevron-right"></i></a></li>
                    <li class="active-page"> Form Wizard</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="widget-wrap">
                    <div class="widget-container margin-top-0">
                        <div class="widget-content">
                            <form action="http://lab.westilian.com/westilo-admin/material-style-sidebar/php/demo.php" method="post" class="j-forms j-multistep" id="checkout-wizard" novalidate>
                                <!-- end /.header-->

                                <div class="form-content">

                                <!-- start steps -->
                                <div class="wizard-breadcrumb number-style">
                                    <div class="row">
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 unit">
                                            <div class="input">
                                                ...
                                                <input class="form-control" type="text" id="post" placeholder="Post code" name="post">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end city post code -->
                                    ...
                                    <div class="unit">
                                        <div class="input">
                                            ...
                                            <textarea class="form-control" placeholder="Additional info" spellcheck="false" id="message" name="message"></textarea>
                                        </div>
                                    </div>
                                    <!-- end message -->
                                ...
                                <fieldset>
                                    ...
                                    <div class="unit">
                                        <div class="input">
                                            ...
                                            <input class="form-control" type="text" id="card_name" placeholder="Name on card" name="card_name">
                                ...
                                <div class="form-footer block-form-footer">
                                    ...
                                    <button type="button" class="btn btn-primary primary-btn multi-next-btn">Next</button>
...
<script src="js/lib/checkout-wizard.js"></script>
