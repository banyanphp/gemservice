...
<section class="main-container">
    <div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    <h2>Form Success State</h2>
                    <p>All form elements success state</p>
                </div>
                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="unit">
                                    <div class="success-message">
                                        ...
                                        <strong>Thanks!</strong> This is success message
                                    </div>
                                </div>
                                <!-- end success message -->
                                ...
                                <div class="unit">
                                    ...
                                    <div class="input success-view">
                                        ...
                                        <input class="form-control" type="text" id="text" placeholder="some text...">
                                    </div>
                                    <span class="success-view">Thanks for your input</span>
                                </div>
                                <!-- end text input -->
                                ...
                                <div class="unit">
                                    ...
                                    <div class="input success-view">
                                        ...
                                        <textarea class="form-control" placeholder="review or comment..." spellcheck="false" id="textarea"></textarea>
                                    </div>
                                    <span class="success-view">Thanks for your comment</span>
                                </div>
                                <!-- end textarea -->
                                ...
                                <div class="unit">
                                    ...
                                    <span class="success-view">Thanks for your selection</span>
                                </div>
                                <!-- end select -->
                                ...
                                <div class="unit">
                                    ...
                                    <div class="input append-big-btn success-view">
                                    ...
                                    <span class="success-view">Thanks for your file</span>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 unit">
                                        ...
                                        <div class="widget left-50 success-view">
                                            <div class="input">
                                        ...
                                        <span class="success-view">Thanks for email</span>
                                    </div>
                                    <div class="col-md-6 unit">
                                        <label class="label">Widget button</label>
                                        <div class="widget right-50 success-view">
                                            <div class="input">
                                        ...
                                        <span class="success-view">Thanks for keywords</span>
                                    </div>
                                </div>
                                <!-- end widget -->
                                ...
                                <!-- start checkbox and radio -->
                                <div class="unit">
                                    <div class="j-row">
                                        <label class="label">Checkbox and Radio</label>
                                        <div class="col-md-3 success-view">
                                ...
                                <div class="unit">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 success-view">
