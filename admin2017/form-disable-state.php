...
<section class="main-container">
    <div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    <h2>Form Disable State</h2>
                    <p>All form elements disable state</p>
                </div>
                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="unit">
                                    ...
                                    <div class="input disabled-view">
                                        ...
                                        <input class="form-control" type="text" id="text" placeholder="some text..." disabled="">
                                    </div>
                                </div>
                                <!-- end text input -->
                                ...
                                <div class="unit">
                                    ...
                                    <div class="input disabled-view">
                                        ...
                                        <textarea class="form-control" placeholder="message..." spellcheck="false" id="textarea" disabled=""></textarea>
                                    </div>
                                </div>
                                <!-- end textarea -->
                                ...
                                <div class="unit">
                                    ...
                                    <label class="input select disabled-view">
                                ...
                                <!-- start append big button -->
                                <div class="unit">
                                    <label class="label">File input</label>
                                    <div class="input append-big-btn disabled-view">
                                        <label class="icon-left" for="append-big-btn">
                                            <i class="fa fa-download"></i>
                                        </label>
                                        <div class="file-button">
                                            Browse
                                            <input type="file" onchange="document.getElementById('append-big-btn').value = this.value;" disabled="">
                                        </div>
                                        <input class="form-control" type="text" id="append-big-btn" readonly="" placeholder="no file selected" disabled="">
                                    </div>
                                </div>
                                <!-- end append big button -->
                                ...
                                <div class="j-row">
                                    <div class="span6 unit">
                                        <label class="label">Widget addon</label>
                                        <div class="widget left-50 disabled-view">
                                            <div class="input">
                                    ...
                                    <div class="span6 unit">
                                        <label class="label">Widget button</label>
                                        <div class="widget right-50 disabled-view">
                                            <div class="input">
                                                <input class="form-control" type="search" placeholder="i'm looking for..." disabled="">
                                            </div>
                                            <button type="submit" class="addon-btn adn-50 adn-right" disabled="">
                                ...
                                <div class="unit">
                                    <div class="row">
                                        <label class="label">Checkbox and Radio</label>
                                        <div class="col-md-3">
                                            <label class="checkbox disabled-view">
                                        ...
                                        <div class="col-md-3">
                                            <label class="radio disabled-view">
                                ...
                                <div class="unit">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label class="checkbox-toggle disabled-view">
                                                <input type="checkbox" disabled="">
                                                <i></i>
                                                Apple
                                            </label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="radio-toggle disabled-view">
                                                <input type="radio" name="radio-toggle" disabled="">
                                                <i></i>
                                                Orange
                                            </label>
                                            <label class="radio-toggle disabled-view">
                                ...
                                <div class="form-footer">
                                    <button type="submit" class="btn btn-success primary-btn processing disabled-view" disabled>Processing...</button>
                                    <button type="reset" class="btn btn-danger secondary-btn disabled-view" disabled>Reset</button>
                                    <button type="submit" class="btn btn-info primary-btn disabled-view" disabled >Submit</button>
                                </div>
                                <!-- end /.footer -->
