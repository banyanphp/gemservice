        ...
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p>A example of item order form</p>
                </div>
                <div class="col-md-6">
            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    <div class="widget-header block-header">
                        ...
                        <p>A example of item order form with validation</p>
                    </div>
                    <div class="widget-container">
                        <div class="widget-content">
                            <form action="http://lab.westilian.com/westilo-admin/material-style-sidebar/php/demo.php" method="post" class="j-forms" id="order-forms-quantity" novalidate>

                                <div class="form-content">

                                   <div class="w-section-header"><h3>Select desired fruits</h3></div>
...
<script src="js/lib/jquery.stepper.js"></script>
<script src="js/lib/j-forms.js"></script>
<script src="js/lib/j-forms-order.js"></script>
<script src="js/lib/j-forms-order-quantity.js"></script>
<!--[if lt IE 10]>
