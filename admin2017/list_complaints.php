                               ...
                               <div class="col-md-6">
                                    <div class="data-align-right">
                                        <div class="tbl-action-toolbar">
                                                    ...
                                                    <a href="export.php" class="btn btn-info " ><i class="zmdi zmdi-archive"></i> Export Excel</a>
...
$sl=0;
$sql = "SELECT * FROM complaints_2017 where status='Pending' and team='' order by complaint_no ";
