        ...
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p>All form elements with validation</p>
                </div>
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        <li><a href="#">Home <i class="zmdi zmdi-chevron-right"></i></a></li>
                        <li><a href="#">Form <i class="zmdi zmdi-chevron-right"></i></a></li>
            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    ...
                    <div class="widget-container margin-top-0 clearfix">
                        ...
                        <form action="http://lab.westilian.com/westilo-admin/material-style-sidebar/php/demo.php" method="post" class="j-forms" id="j-forms-validation" novalidate>

                        <div class="form-content">

                        <div class="w-section-header"><h3>Input</h3></div>

                        <div class="unit">
                            <label class="label">Required field</label>
                            <div class="input">
                                <label class="icon-right" for="text">
                                    <i class="fa fa-edit"></i>
                                </label>
                                <input class="form-control" type="text" placeholder="required field" id="text" name="req_field">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 unit">
                                ...
                                <div class="input">
                                    ...
                                    <input class="form-control" type="email" placeholder="email@example.com" name="email" id="email">
                                </div>
                            </div>
                            <div class="col-md-6 unit">
                                ...
                                <div class="input">
                                    ...
                                    <input class="form-control" type="url" placeholder="http://www.example.com" name="url" id="url">
                                </div>
                            </div>
                        </div>
                        <!-- end email url -->
                        ...
                        <div class="w-section-header"><h3>Password</h3></div>
                        ...
                        <div class="w-section-header"><h3>One field from group</h3></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 unit">
                                ...
                                <div class="input">
                                    ...
                                    <input class="form-control required-group" type="text" name="first_name" id="first_name">
                                </div>
                            </div>
                            <div class="col-md-6 unit">
                                ...
                                <div class="input">
                                    ...
                                    <input type="text" class="required-group form-control" name="last_name" id="last_name">
                                </div>
                            </div>
                        </div>
                        <!-- end one field form group -->

                        <div class="w-section-header"><h3>Checkbox and radio</h3></div>

                        <!-- start checbox and radio -->
                        <div class="row">
                            <div class="col-md-4 unit check">
                        ...
                        <!--  end checbox and radio -->

                        <div class="w-section-header"><h3>Value</h3></div>
                        ...
                        <div class="row">
                            <div class="col-md-4 unit">
                                ...
                                <div class="input">
                                    <input class="form-control" type="text" name="min_val">
                                </div>
                            </div>
                            <div class="col-md-4 unit">
                                <label class="label">Range value</label>
                                <div class="input">
                                    <input class="form-control" type="text" name="range_val">
                                </div>
                            </div>
                            <div class="col-md-4 unit">
                                <label class="label">Max value</label>
                                <div class="input">
                                    <input class="form-control" type="text" name="max_val">
                                </div>
                            </div>
                        </div>
                        <!-- end value -->

                        <div class="w-section-header"><h3>Length</h3></div>
                        ...
                        <div class="row">
                            <div class="col-md-4 unit">
                                ...
                                <div class="input">
                                    <input class="form-control" type="text" name="min_len">
                                </div>
                            </div>
                            <div class="col-md-4 unit">
                                <label class="label">Range length</label>
                                <div class="input">
                                    <input class="form-control" type="text" name="range_len">
                                </div>
                            </div>
                            <div class="col-md-4 unit">
                                <label class="label">Max length</label>
                                <div class="input">
                                    <input class="form-control" type="text" name="max_len">
                                </div>
                            </div>
                        </div>
                        <!-- end length -->

                        <div class="w-section-header"><h3>Digits and decimal numbers</h3></div>

                        <!-- start digits and decimal numbers -->
                        <div class="row">
                            <div class="col-md-6 unit">
                                ...
                                <div class="input">
                                    ...
                                    <input class="form-control" type="text" name="digits" id="digits">
                                </div>
                            </div>
                            <div class="col-md-6 unit">
                                <label class="label">Decimals</label>
                                <div class="input">
                                    <label class="icon-right" for="decimals">
                                        <i class="fa fa-check"></i>
                                    </label>
                                    <input class="form-control" type="text" name="decimals" id="decimals">
                                </div>
                            </div>
                        </div>
                        <!-- end digits and decimal numbers -->

                        <div class="w-section-header"><h3>If checkbox is checked</h3></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 unit">
                                <div class="input disabled-view">
                                    ...
                                    <input class="form-control" type="text" id="enable-input" name="enable_input" placeholder="enable/disable input" disabled="">
                                </div>
                            </div>
                        </div>
                        <!-- end enable input -->
                        ...
                        <div class="form-footer">
                            <button type="submit" class="btn btn-success primary-btn">Validate</button>
                        </div>
                        <!-- end /.footer -->
