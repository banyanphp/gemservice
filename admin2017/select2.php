                ...
                <div class="widget-wrap">
                    ...
                    <div class="widget-container">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Single Select</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Select</label>
                            <div class="col-md-8">
                                <div class="input-group select2-bootstrap-append btn-append">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Loading remote data (AJAX support)</label>
                            <div class="col-md-8">
                                <select class="ajax-data form-control">
                            ...
                            <pre class="code language-js">
                                 ...
                                 *  */
                                if ($.fn.select2) {
                                    var placeholder = "Select a team members";
