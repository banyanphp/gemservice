...
<section class="main-container">
    <div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    <h2>Numbering Form Wizard</h2>
                    <p>Stepy form wizard with number style</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="widget-wrap">
                    <div class="widget-container margin-top-0">
                        <div class="widget-content">
                            <form action="http://lab.westilian.com/westilo-admin/material-style-sidebar/php/demo.php" method="post" class="j-forms j-multistep" id="j-forms" novalidate>
                                <!-- end /.header-->
