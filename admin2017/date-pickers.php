    ...
    <div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    <h2>Date Pickers</h2>
                    <p>Bootstrap date pickers and date rangepickers</p>
                </div>
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        <li><a href="#">Home <i class="zmdi zmdi-chevron-right"></i></a></li>
                        <li><a href="#">Form <i class="zmdi zmdi-chevron-right"></i></a></li>
                        <li class="active-page"> Date Pickers</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="widget-content">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Date Picker</label>
                                    <div class="col-md-7">
                                        <input type="text" class="form-control input-date-picker">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Component Date Picker</label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Inline Date Picker</label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Range Date Picker</label>
                                    <div class="col-md-7">
                ...
                <div class="widget-wrap">
                    ...
                    <div class="widget-container">
                        <div class="widget-content">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-5 control-label">With all options</label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Date Range Pick</label>
                                    <div class="col-md-7">
                                        <input class="form-control input-daterange-datepicker" type="text" name="daterange" value="01/01/2015 - 01/31/2015"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Date Range With Time</label>
                                    <div class="col-md-7">
                                        <input type="text" class="form-control input-daterange-timepicker" name="daterange" value="01/01/2015 1:30 PM - 01/01/2015 2:00 PM"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Limit Selectable Dates</label>
                                    <div class="col-md-7">
