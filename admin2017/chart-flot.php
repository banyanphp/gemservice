    ...
    <div class="col-md-6">
        <div class="widget-wrap">
            <div class="widget-header block-header margin-bottom-0 clearfix">
                <div class="pull-left">
                    <h3>Combine Chart</h3>
                    <p>Combine flot chart <code>id="combine-chart"</code></p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flotchart-container">
                                <div id="combine-chart-legend"></div>
                                <div id="combine-chart" class="flot-chart">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-md-6">
        <div class="widget-wrap">
            <div class="widget-header block-header margin-bottom-0 clearfix">
                <div class="pull-left">
                    <h3>Line Chart</h3>
                    <p>Line flot chart <code> id="line-chart"</code></p>
                </div>
                <div class="pull-right w-action">
                    <ul class="widget-action-bar">
                        <li class="dropdown">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Spline Chart</h3>
                        <p>FLot spline chart <code>id="spline-chart" </code></p>
                    </div>
                    <div class="pull-right w-action">
                        <ul class="widget-action-bar">
                            <li class="dropdown">
                ...
                <div class="widget-container">
                    <div class="widget-content">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="flotchart-container">
                                    <div id="spline-chart-legend"></div>
                                    <div id="spline-chart" class="flot-chart">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-md-6">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Multi Spline Chart</h3>
                        <p>Multi spline flot chart <code>id="multi-spline-chart"</code></p>
                    </div>
                    <div class="pull-right w-action">
                        <ul class="widget-action-bar">
                            <li class="dropdown">
                ...
                <div class="widget-container">
                    <div class="widget-content">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="flotchart-container">
                                    <div id="multi-spline-chart-legend"></div>
                                    <div id="multi-spline-chart" class="flot-chart"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="widget-wrap">
            <div class="widget-header block-header margin-bottom-0 clearfix">
                <div class="pull-left">
                    ...
                    <p>Flot curved line chart <code>id="curved-line-chart"</code></p>
                </div>
                <div class="pull-right w-action">
                    <ul class="widget-action-bar">
                        <li class="dropdown">
            ...
            <div class="widget-container">
                <div class="widget-content">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flotchart-container">
                                <div id="curved-line-chart-legend"></div>
    ...
    <div class="col-md-6">
        <div class="widget-wrap">
            <div class="widget-header block-header margin-bottom-0 clearfix">
                <div class="pull-left">
                    <h3>Area Chart</h3>
                    <p>Flot area chart <code>id="area-chart"</code></p>
                </div>
                <div class="pull-right w-action">
                    <ul class="widget-action-bar">
                        <li class="dropdown">
        ...
        <div class="widget-wrap">
            <div class="widget-header block-header margin-bottom-0 clearfix">
                <div class="pull-left">
                    ...
                    <p>Flot realtime update chart <code>id="realtime-chart"</code></p>
                </div>
                <div class="pull-right w-action">
                    <ul class="widget-action-bar">
                        <li class="dropdown">
            ...
            <div class="widget-container">
                <div class="widget-content">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flotchart-container">
                                <div id="reatime-chart-legend"></div>
                                <div id="realtime-chart" class="flot-chart">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-md-6">
        <div class="widget-wrap">
            <div class="widget-header block-header margin-bottom-0 clearfix">
                <div class="pull-left">
                    <h3>Pie Chart</h3>
                    <p>Flot donut pie chart <code>id="pie-chart"</code></p>
                </div>
                <div class="pull-right w-action">
                    <ul class="widget-action-bar">
                        <li class="dropdown">
...
<script src="js/lib/chart/flot/jquery.flot.symbol.min.js"></script>
<!--Forms-->
...
<script src="js/lib/charts.init.js"></script>
