                    ...
                    <div class="dropdown-menu notifications-tabs">
                        <div>
                            <ul class="nav material-tabs nav-tabs" role="tablist">
                                <li class="active"><a href="#message-notification" role="tab" data-toggle="tab">Message</a></li>
                                <li><a href="#notifications" role="tab" data-toggle="tab">Notifications</a></li>
                            </ul>
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="message-notification">
...
<section class="main-container">
    ...
    <div class="page-header filled full-block light">
        <div class="row">
            <div class="col-md-6">
                <h2>Checkout Form</h2>
                <p>A example of check out form validation</p>
            </div>
            <div class="col-md-6">
                <ul class="list-page-breadcrumb">
                    <li><a href="#">Home <i class="zmdi zmdi-chevron-right"></i></a></li>
                    <li><a href="#">Form <i class="zmdi zmdi-chevron-right"></i></a></li>
                    <li class="active-page"> Checkout Form</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    <div class="widget-header block-header">
                        <h3>Checkout form validation</h3>
                        <p>A checkout form with validation </p>
                    </div>
                    <div class="widget-container">
                        <div class="widget-content">
                        <form action="http://lab.westilian.com/westilo-admin/material-style-sidebar/php/demo.php" method="post" class="j-forms" id="j-forms" novalidate>
                        ...
                        <div class="form-footer">
                            <button type="submit" class="btn btn-success primary-btn">Continue</button>
