...
<section class="main-container">
    <div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    <h2>Notifications in Rightbar</h2>
                    <p>All notifications and messages showed in rightbar</p>
                </div>
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        <li><a href="#">Home <i class="zmdi zmdi-chevron-right"></i></a></li>
                        <li><a href="#">Layout <i class="zmdi zmdi-chevron-right"></i></a></li>
                        <li class="active-page"> Notifications Rightbar</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    <div class="widget-header">
                        <h3>Sample Text</h3>
                        <p>
                            All notifications is showing in rightbar
                        </p>
                    </div>
...
<div class="rightbar-container">
    <div>
        <ul class="nav material-tabs nav-tabs" role="tablist">
            <li class="active"><a href="#message" aria-controls="message" role="tab" data-toggle="tab">Message <span class="noty-bubble">60</span></a></li>
            <li><a href="#notifications" aria-controls="notifications" role="tab" data-toggle="tab">Notifications <span class="noty-bubble">10</span></a></li>
        </ul>
