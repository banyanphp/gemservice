...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-6">
            <h2>Exportable Tables</h2>
            <p>Export table in any extensions</p>
        </div>
        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="widget-header">
                                        <h3>Export data from table</h3>
                                        <p>
                                            Export any table data to 11 file extensions
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="data-align-right">
                                        <div class="tbl-action-toolbar">
                                            <ul>
                                                ...
                                                <li><a href="#add" class="btn add-row btn-primary">Add New</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
