...
<div class="widget-wrap">
    <div class="widget-header block-header clearfix">
        <div class="pull-left">
            <h3>jQueryUi Date Pickers</h3>
            <p>All examples of jQueryUi Date Pickers</p>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <form action="#" class="j-forms" novalidate>
                        ...
                        <div class="form-content">
                            ...
                            <div class="w-section-header"><h3>Single date</h3></div>
                            ...
                            <div class="j-row">
                                ...
                                <div class="span6 unit">
                                    <div class="widget right-50">
                                        <div class="input">
                                            <input class="form-control" type="text" id="date-widget" placeholder="datepicker with a widget" readonly="">
                                        </div>
                            ...
                            <div class="w-section-header"><h3>Popup time interval</h3></div>
                            ...
                            <div class="j-row">
                                <div class="span6 unit">
                                    <div class="input">
                                        ...
                                        <input class="form-control" type="text" id="popup-from" placeholder="date from..." readonly="">
                                    </div>
                                </div>
                                <div class="span6 unit">
                                    <div class="input">
                                        <label class="icon-right" for="popup-to">
                                            <i class="fa fa-calendar"></i>
                                        </label>
                                        <input class="form-control" type="text" id="popup-to" placeholder="date to..." readonly="">
                                    </div>
                                </div>
                            </div>
                            <!-- end popup time interval -->

                            <div class="w-section-header"><h3>Inline time interval</h3></div>

                            <!-- start Inline time interval -->
                            <!-- for proper datapicker work -->
                            <!-- don't forget to add appropriate javascript code to your form-->
                            <!-- from the bottom of this page-->
                            <div class="j-row">
                                <div class="span6 unit">
                                    <div class="input unit">
                                        <label class="icon-right" for="inline-range-from">
                                            <i class="fa fa-calendar"></i>
                                        </label>
                                ...
                                <div class="span6 unit">
                                    <div class="input unit">
                                        <label class="icon-right" for="inline-range-to">
                                            <i class="fa fa-calendar"></i>
                                        </label>
                            ...
                            <!-- end Inline time interval -->

                            <div class="w-section-header"><h3>Inline date</h3></div>
                            ...
                            <div class="unit">
                                <div class="input unit">
                                    <label class="icon-right" for="inline-single">
                                        <i class="fa fa-calendar"></i>
                                    </label>
                                    <input class="form-control" type="text" id="inline-single" readonly="">
                                </div>
                                <div id="inline"></div>
                            </div>
                            <!-- end Inline date -->
