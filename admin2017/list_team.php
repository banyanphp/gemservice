...
?>
                            <tr>
							 <td><?php echo $sl; ?></td>
                                <td><?php echo $query['team_name']; ?></td>
                                <td><?php 
								$id=$query['team_head'];$ids=$query['id'];
								$sqls = "SELECT * FROM employee where id=$id";
$results = mysql_query($sqls);
$querys = mysql_fetch_array($results);
echo $querys['emp_name'];
								?>(<?php echo $querys['emp_code']; ?>)</td>
                          
                               
                              
                                <td class="td-right"><a class="row-edit" href="view_team_members.php?id=<?php echo $ids;?>" ><span class="zmdi zmdi-eye"></span></a>
<a class="row-edit"  onclick="update(<?php echo $query['id']; ?>)"><span class="zmdi zmdi-edit"></span></a>
