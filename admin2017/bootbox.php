...
<div class="widget-content">
    <div class="row">
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
            <a href="#" data-bb="alert" class="btn btn-default btn-block"><i class="icon-play"></i>Alert</a>
        </div>
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
            <a href="#" data-bb="confirm" class="btn btn-default btn-block"><i class="icon-play"></i>Confirm</a>
        </div>
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
            <a href="#" data-bb="prompt" class="btn btn-default btn-block"><i class="icon-play"></i>Prompt</a>
        </div>
    </div>
    <div class="row">
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
            <a href="#" data-bb="dialog" class="btn btn-default btn-block"><i class="icon-play"></i> BootBox Dialog</a>
        </div>
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
            <a href="#" data-bb="custom_html" class="btn btn-default btn-block"><i class="icon-play"></i> HTML Contents</a>
        </div>
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
