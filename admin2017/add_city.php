        ...
        <div class="col-md-12" style="height:492px;">
             <div class="widget-wrap">
                    <div class="widget-header block-header margin-bottom-0 clearfix">
                        <div class="pull-left">
                            <h3 style="font-weight: 900;">Add Place </h3>
...
success : function(response){
  ...
  if(response==1){
$("#success").html("City Name added successfully!");
  }
  else{
$("#errors").html("already " +  password +"    exist in the database");
  }
