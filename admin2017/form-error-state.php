...
<section class="main-container">
    <div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    <h2>Form Error State</h2>
                    <p>All form elements error state</p>
                </div>
                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="unit">
                                    <div class="error-message">
                                        ...
                                        <strong>Oops!</strong> This is error message
                                    </div>
                                </div>
                                <!-- end error message -->
                                ...
                                <div class="unit">
                                    ...
                                    <label class="input select error-view">
                                    ...
                                    <span class="error-view">Please select an option</span>
                                </div>
                                <!-- end select -->
                                ...
                                <div class="unit">
                                    ...
                                    <div class="input append-big-btn error-view">
                                    ...
                                    <span class="error-view">Please select a file</span>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 unit">
                                        ...
                                        <div class="widget left-50 error-view">
                                            <div class="input">
                                        ...
                                        <span class="error-view">Please enter an email</span>
                                    </div>
                                    <div class="col-md-6 unit">
                                        <label class="label">Widget button</label>
                                        <div class="widget right-50 error-view">
                                            <div class="input">
                                        ...
                                        <span class="error-view">Please enter keywords</span>
                                    </div>
                                </div>
                                <!-- end widget -->
