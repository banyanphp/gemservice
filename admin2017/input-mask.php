...
<section class="main-container">
    <div class="container-fluid">
        <div class="page-header filled full-block light single-line">
            <div class="row">
                <div class="col-md-6">
                    <h2>Input Mask</h2>
                </div>
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page"> Input Mask</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-container">
                        <div class="widget-content">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Date &amp; Hour</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control date_time-mask"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Zip-Code With Callbacks</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control cep_with_callback-mask"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Crazy Zip-Code</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control crazy_cep-mask"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Mask placeholder option</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control placeholder-mask"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Telephone with Code Area</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control phone_with_ddd-mask"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">US Telephone</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control phone_us-mask"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Mixed Type Mask</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control percent-mask"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">IP Address</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control ip_address-mask"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Mask with Clear If Not Match Option</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control clear-if-not-match-mask"/>
                                    </div>
                                </div>
                            </form>
                            <h3>Markup</h3>
