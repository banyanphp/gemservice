...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-6">
            <h2>Form Tooltip Elements</h2>
            <p>All form elements with tooltips</p>
        </div>
        <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <form action="#" class="j-forms" novalidate>
                        ...
                        <div class="form-content">
                            ...
                            <div class="w-section-header"><h3>Text tooltip</h3></div>

                            <!-- start top tooltips -->
                            <div class="row">
                                <div class="col-md-6 unit">
                                    <label class="label">Top-left tooltip</label>
                                    <div class="input">
                                        <label class="icon-left" for="left-top">
                                            <i class="fa fa-user"></i>
                                        </label>
                                        <input class="form-control" type="text" id="left-top" placeholder="your name...">
                                        <span class="tooltip tooltip-left-top">Tooltip or useful information</span>
                                    </div>
                                </div>
                                <div class="col-md-6 unit">
                                    <label class="label">Top-right tooltip</label>
                                    <div class="input">
                                        <label class="icon-right" for="right-top">
                                            <i class="fa fa-phone"></i>
                                        </label>
                                        <input class="form-control" type="text" id="right-top" placeholder="your phone...">
                                        <span class="tooltip tooltip-right-top">Tooltip or useful information</span>
                                    </div>
                                </div>
                            </div>
                            <!-- end top tooltips -->
                            ...
                            <div class="row">
                                <div class="col-md-6 unit">
                                    <label class="label">Left tooltip</label>
                                    <div class="input">
                                        <label class="icon-left" for="left-side">
                                            <i class="fa fa-lock"></i>
                                        </label>
                                        <input class="form-control" type="password" id="left-side" placeholder="your password...">
                                        <span class="tooltip tooltip-left-side">Tooltip or useful information</span>
                                    </div>
                                </div>
                                <div class="col-md-6 unit">
                                    <label class="label">Right tooltip</label>
                                    <div class="input">
                                        <label class="icon-right" for="right-side">
                                            <i class="fa fa-unlock"></i>
                                        </label>
                                        <input class="form-control" type="password" id="right-side" placeholder="confirm password...">
                                        <span class="tooltip tooltip-right-side">Tooltip or useful information</span>
                                    </div>
                                </div>
                            </div>
                            <!-- end side tooltips -->

                            <!-- start bottom tooltips -->
                            <div class="row">
                                <div class="col-md-6 unit">
                                    <label class="label">Bottom-left tooltip</label>
                                    <div class="input">
                                        <label class="icon-left" for="left-bottom">
                                            <i class="fa fa-envelope"></i>
                                        </label>
                                        <input class="form-control" type="text" id="left-bottom" placeholder="example@domain.com">
                                        <span class="tooltip tooltip-left-bottom">Tooltip or useful information</span>
                                    </div>
                                </div>
                                <div class="col-md-6 unit">
                                    <label class="label">Bottom-right tooltip</label>
                                    <div class="input">
                                        <label class="icon-right" for="right-bottom">
                                            <i class="fa fa-globe"></i>
                                        </label>
                                        <input class="form-control" type="text" id="right-bottom" placeholder="http://www.example.com/">
                            ...
                            <div class="w-section-header"><h3>Image tooltip</h3></div>

                            <!-- start image tooltip -->
                            <div class="unit">
                                <label class="label">Credit card information</label>
                                <div class="input">
                                    <label class="icon-right" for="first-name">
                                        <i class="fa fa-user"></i>
                                    </label>
                                    <input class="form-control" type="text" id="first-name" placeholder="Name on credit card...">
                                    <span class="tooltip-image tooltip-right-top"><img src="images/name.jpg" alt="tooltip image" /></span>
                                </div>
                            </div>
                            <!-- end image tooltip -->
                            ...
                            <div class="row">
                                <div class="col-md-9 unit">
                                    <div class="input">
                                        ...
                                        <input class="form-control" type="text" id="number" placeholder="Number on credit card...">
                                        <span class="tooltip-image tooltip-right-top"><img src="images/number.jpg" alt="tooltip image" /></span>
                                    </div>
                                </div>
                                <div class="col-md-3 unit">
                                    <div class="input">
                                        ...
                                        <span class="tooltip-image tooltip-right-top"><img src="images/cvv.jpg" alt="tooltip image" /></span>
                                    </div>
                                </div>
                            </div>
                            <!-- end image tooltip -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 unit">
                                    <label class="input select">
                                        ...
                                        <span class="tooltip-image tooltip-left-side"><img src="images/month.jpg" alt="tooltip image" /></span>
                                        <i></i>
                                    </label>
                                </div>
                                <div class="col-md-5 unit">
                                    <label class="input select">
                                        ...
                                        <span class="tooltip-image tooltip-left-side"><img src="images/year.jpg" alt="tooltip image" /></span>
                                        <i></i>
                                    </label>
                                </div>
                            </div><!-- end image tooltip -->
