        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="task_tab">
                <ul class="task-box-list">
                    <li><a href="#"><i class="zmdi zmdi-assignment"></i><span>All Task</span><span class="new-item-count">20</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-file-text"></i><span>New Task</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-assignment-check"></i><span>To Do</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-refresh-sync-alert"></i><span>Overdue</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-check"></i><span>Done</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-archive"></i><span>Archive</span></a>
                    </li>
                </ul>
            </div>
            <div role="tabpanel" class="tab-pane" id="email_tab">
                ...
                <ul class="mailbox-list">
                    <li><a href="#"><i class="zmdi zmdi-inbox"></i><span>Inbox</span><span class="new-item-count">20</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-star"></i><span>Stared</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-mail-send"></i><span>Sent Mail</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-tag"></i><span>Important</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-collection-text"></i><span>Draft</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-delete"></i><span>Trash</span></a>
                    </li>
                </ul>
                <div class="email-label-container">
                    <h5>Label</h5>
                    <ul class="label-list">
                        <li class="item-label" data-color="#4caf50"><a href="#" class="clearfix"><span class="pull-left">Envato</span><span class="label-color pull-right"></span></a>
                        </li>
                        <li class="item-label" data-color="#9c27b0"><a href="#" class="clearfix"><span class="pull-left">Support</span><span class="label-color pull-right"></span></a>
                        </li>
                        <li class="item-label" data-color="#f4511e"><a href="#" class="clearfix"><span class="pull-left">Product License</span><span class="label-color pull-right"></span></a>
                        </li>
                        <li class="item-label" data-color="#8d6e63"><a href="#" class="clearfix"><span class="pull-left">Office</span><span class="label-color pull-right"></span></a>
                        </li>
                    </ul>
            ...
            <div role="tabpanel" class="tab-pane" id="support_tab">
                <ul class="support-box-list">
                    <li><a href="#"><i class="zmdi zmdi-assignment"></i><span>All Tickets</span><span class="new-item-count">20</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-file-text"></i><span>New Tickets</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-refresh-sync-alert"></i><span>Pending Tickets</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-check"></i><span>Resloved</span></a>
                    </li>
                    <li><a href="#"><i class="zmdi zmdi-archive"></i><span>Archive</span></a>
                    </li>
                </ul>
    ...
    <div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    <h2>Tabby Leftbar</h2>
                    <p>You can use tab in leftbar</p>
                </div>
                <div class="col-md-6">
