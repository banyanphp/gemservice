...
<div class="widget-wrap">
    <div class="widget-header block-header clearfix">
        <div class="pull-left">
            <h3>jQuery Time Pickers</h3>
            <p>All examples of jQuery UI timepickers</p>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <form action="#" class="j-forms" novalidate>
                        ...
                        <div class="form-content">
                            ...
                            <div class="w-section-header"><h3>Single date and time</h3></div>

                            <!-- start single date and time -->
                            <!-- for proper timepicker work -->
                            ...
                            <div class="row">
                                <div class="col-md-6 unit">
                                    <div class="input">
                                        ...
                                        <input class="form-control" type="text" id="timepic-1" name="timepic-1" placeholder="datepicker with time" readonly="">
                                    </div>
                                </div>
                                <div class="col-md-6 unit">
                                    <div class="widget right-50">
                                        <div class="input">
                                            <input class="form-control" type="text" id="timepic-2" name="timepic-2" placeholder="timepicker" readonly="">
                                        </div>
                                        <label class="addon adn-50 adn-right" for="timepic-2">
                                            <i class="fa fa-clock-o"></i>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <!-- end single date and time -->

                            <div class="w-section-header"><h3>Popup date/time interval</h3></div>

                            <!-- start popup time interval -->
                            <!-- for proper timepicker work -->
                            <!-- don't forget to add appropriate javascript code to your form-->
                            <!-- from the bottom of this page-->
                            <div class="row">
                                <div class="col-md-6 unit">
                                    <div class="input">
                                        <label class="icon-right" for="pop-time-1">
                                            <i class="fa fa-calendar"></i>
                                        </label>
                                        <input class="form-control" type="text" id="pop-time-1" name="pop-time-1" placeholder="date from..." readonly="">
                                    </div>
                                </div>
                                <div class="col-md-6 unit">
                                    <div class="input">
                                        <label class="icon-right" for="pop-time-2">
                                            <i class="fa fa-calendar"></i>
                                        </label>
                                        <input class="form-control" type="text" id="pop-time-2" name="pop-time-2" placeholder="date to..." readonly="">
                                    </div>
                                </div>
                            </div>
                            <!-- end popup time interval -->

                            <div class="w-section-header"><h3>Inline date/time</h3></div>

                            <!-- start inline date/time picker -->
                            <!-- for proper timepicker work -->
                            <!-- don't forget to add appropriate javascript code to your form-->
                            <!-- from the bottom of this page-->
                            <div class="unit">
                                <div class="input unit">
                                    <label class="icon-right" for="i-single-alt">
                                        <i class="fa fa-calendar"></i>
                                    </label>
                                    <input class="form-control" type="text" name="inline" id="i-single-alt" readonly="">
                                </div>
                                <div id="i-single"></div>
                            </div>
                            <!-- end inline date/time picker -->
