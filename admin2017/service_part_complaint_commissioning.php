...
<?php if($chk_comp_result['status']=='Pending') {?>
                                                           <option value="Goahead">Go ahead</option>
<?php } ?>
<option value="Completed">Completed</option><option value="Need Help">Need Help</option><option value="Need Spares">Need Spares</option><option value="Others">Others</option>
                                                        </select>    
                                                </div>
                                            </div></div>
