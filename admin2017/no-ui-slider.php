...
<div class="widget-wrap">
    <div class="widget-header block-header margin-bottom-0 clearfix">
        <div class="pull-left">
            <h3>Pricing Slider</h3>
            <p>jQuery no ui range slider</p>
        </div>
    </div>
<div class="widget-container">
<div class="widget-content">
    <div class="noui-slider-ex">
        <div class="pricing-range">
            ...
            <div class="slider-input-range">
                <div class="row">
                    <div class="col-md-6">
                        <span> Form:</span>
                        <input type="text" class="form-control" id="slider-snap-value-lower">
                    </div>
                    <div class="col-md-6">
                        <span> To:</span>
                        <input type="text" class="form-control" id="slider-snap-value-upper">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="widget-wrap">
            <div class="widget-header block-header margin-bottom-0 clearfix">
                <div class="pull-left">
                    ...
                    <p>jQuery no ui horizontal range slider</p>
                </div>
            </div>
            <div class="widget-container">
                <div class="widget-content">
                    ...
                    <div class="noui-slider-ex">
                        ...
                        <div class="range-slider-con">
                            <div id="pips-range-01">
                            </div>
                        </div>
                        <div class="range-slider-con">
                            <div id="pips-range-02">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        ...
                        <p>jQuery no ui vertical range slider</p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="noui-slider-ex vertical">
                                    <div class="pips-range" id="pips-range-vertical">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="noui-slider-ex vertical">
                                    <div class="pips-range" id="pips-range-vertical-01">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="noui-slider-ex vertical">
                                    <div id="pips-range-vertical-02">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="js/lib/jquery.nouislider.js"></script>
