    ...
    <div class="topbar-left pull-left">
        <div class="clearfix">
            <ul class="left-branding pull-left clickablemenu ttmenu dark-style menu-color-gradient">
                ...
                <li>
                    <div class="logo">
                        <a href="index-2.html" title="Admin Template"><img src="images/logo.png" alt="logo"></a>
                    </div>
                </li>
            </ul>
        ...
        <div class="col-md-12">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Essential Spark Charts</h3>
                        <p>Some essenatial sparkline chart using data attribute</p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="paddding-bottom-30">
                                <div class="row">
                                        <div class="col-md-8">
                                            <h3 class="spark-header">Sparkline pie chart</h3>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="spark-pie-chart" data-spark-type="pie" data-spark-data="1,1,2,2" data-spark-width="50" data-spark-height="50" data-spark-slicecolors="#00C4B2,#273746,#FFC300,#FF5733"></div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <h3 class="spark-header">Sparkline line chart</h3>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="sparkline" data-type="line" data-resize="true" data-height="40" data-width="100" data-line-width="1.5" data-line-color="#80cbc4" data-spot-color="#26a69a" data-fill-color="false" data-highlight-line-color="#4db6ac" data-highlight-spot-color="#ff8a65" data-spot-radius="0" data-data="[10,8,9,7,6,4,5,8,6,4,5,7]"></div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <h3 class="spark-header">Sparkline bar chart</h3>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="sparkline" data-type="bar" data-resize="true" data-height="40" data-width="100" data-bar-color="#26a69a" data-bar-spacing="3" data-bar-width="6" data-data="[5,4,8,9,7,3,6,6,9,5]"></div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <h3 class="spark-header">Sparkline negative bar chart</h3>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="sparkline" data-type="bar" data-resize="true" data-height="30" data-width="100" data-bar-color="#66bb6a" data-bar-spacing="3" data-bar-width="6" data-data="[5,4,8,9,-7,3,6,6,9,5]"></div>
            ...
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        ...
                        <p>Sparkline chart with spot</p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <div class="sparkline" data-type="line" data-resize="true" data-height="120" data-width="100%" data-line-width="1.5" data-line-color="#80cbc4" data-spot-color="#26a69a" data-fill-color="false" data-highlight-line-color="#4db6ac" data-highlight-spot-color="#ff8a65" data-spot-radius="3" data-data="[4,3,5,7,9,9,8,7,6,6,4,7,8,4,3,2,2,5,6,7]"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Stack Chart</h3>
                        <p>Spark stack line chart</p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <div class="sparkline" data-type="line" data-resize="true" data-height="120" data-width="100%" data-line-width="1" data-line-color="#00C4B2" data-spot-color="#148175" data-fill-color="false" data-highlight-line-color="#0097a7" data-highlight-spot-color="#81c784" data-spot-radius="3" data-data="[10,8,9,7,6,4,5,8,6,4,5,7]" data-stack-line-color="#43a047" data-stack-fill-color="rgba(165,214,167,.5)" data-stack-spot-color="#ef6c00" data-stack-spot-radius="3" data-compositedata="[6,8,5,4,3,4,6,5,7,5,4,6]"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Sparkline Chart</h3>
                        <p>Sparkline chart without spot</p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <div class="sparkline" data-type="line" data-resize="true" data-height="120" data-width="100%" data-line-width="1.5" data-line-color="#80cbc4" data-spot-color="#26a69a" data-fill-color="false" data-highlight-line-color="#4db6ac" data-highlight-spot-color="#ff8a65" data-spot-radius="0" data-data="[4,3,5,7,9,9,8,7,6,6,4,7,8,4,3,2,2,5,6,7]"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Stack Chart</h3>
                        <p>Spark stack line chart without spot</p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <div class="sparkline" data-type="line" data-resize="true" data-height="120" data-width="100%" data-line-width="1" data-line-color="#00C4B2" data-spot-color="#148175" data-fill-color="false" data-highlight-line-color="#0097a7" data-highlight-spot-color="#81c784" data-spot-radius="0" data-data="[10,8,9,7,6,4,5,8,6,4,5,7]" data-stack-line-color="#43a047" data-stack-fill-color="rgba(165,214,167,.5)" data-stack-spot-color="#ef6c00" data-stack-spot-radius="0" data-compositedata="[6,8,5,4,3,4,6,5,7,5,4,6]"></div>
                    </div>
                </div>
            </div>
        </div>
