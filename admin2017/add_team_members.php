                                ...
                                <div class="col-md-6">
                                    <form class="form-horizontal" id="addcity">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=" col-md-8">
                                                 <select class="form-control"  name="head" id="head" placeholder="select team members">
...
<?php $x = mysql_query("select * from team");
                            ...
                            <div class="col-md-8">
                                <select id="multiple" class="form-control select2-multiple" multiple name="members">
 									 ...
 									 <?php 
									 $xx = mysql_query("select * from team_members");
									 $i='';
...
$t=substr($i, 0, -1);
												...
												?>	<option value="<?php echo $yyy['id'];?>"><?php echo $yyy['emp_name'];?>(<?php echo $yyy['emp_code'];?>)</option> 									
...
$.ajax({
type : 'POST',
url : 'add_team__members_process.php',
data: {
            team:head,
			member:multiple
