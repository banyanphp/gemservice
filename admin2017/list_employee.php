                                    ...
                                    <div class="data-align-right">
                                        <div class="tbl-action-toolbar">
                                            <ul>
                                                ...
                                                <li><a href="add_employee.php" class="btn add-row btn-primary">Add New</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
?>
                            <tr>
							 <td><?php echo $sl; ?></td>
                                <td><?php echo $query['emp_code']; ?></td>
                                <td><a href="#"><?php echo $query['emp_name']; ?></a></td>
                               
                                <td data-value="1"><a class="label label-success"  title="Active" href="employee_details.php?id=<?php echo $query['id']; ?>">Details</span></a></td>
                                <td class="td-right"><a class="row-edit" href="edit_employee.php?appid=<?php echo $query['id']; ?>"><span class="zmdi zmdi-edit"></span></a>
