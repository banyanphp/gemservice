            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page"> Tags Input</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="widget-content">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Defaults:</label>
                                    <div class="col-md-8">
                                        <input type="text" class="tags tags-input" data-type="tags" value="foo,bar,baz,roffle"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Technologies: (Programming languages in yellow)</label>
                                    <div class="col-md-8">
                                        <input type="text" class="tags tags-input" data-type="highlighted-tags" data-highlight-color="#e6e39c" value="php,ios,javascript,ruby,android,kindle"/>
                                    </div>
                                </div>
                            </form>
                            <h3>Markup</h3>
