        ...
        <div class="col-md-6">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Line Chart</h3>
                        <p>Chart js line chart <code>&lt;canvas id=&quot;line-canvas&quot; height=&quot;200&quot; width=&quot;300&quot;&gt;&lt;/canvas&gt;</code> </p>
                    </div>
                </div>
                    ...
                    <div class="widget-content">
                        <div id="js-line-chart-legend" class="chart-legend"></div>
                            ...
                            <div class="canvas-container">
                                <canvas id="line-canvas" height="200" width="300"></canvas>
                            </div>
            ...
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        ...
                        <p>Chart js curved line chart <code>&lt;canvas id=&quot;curved-line-canvas&quot; height=&quot;200&quot; width=&quot;300&quot;&gt;&lt;/canvas&gt;</code> </p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        ...
                        <div class="canvas-container">
                            <canvas id="curved-line-canvas" height="200" width="300"></canvas>
                        </div>
        ...
        <div class="col-md-6">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Pie Chart</h3>
                        <p>Chart js pie chart <code>&lt;canvas id=&quot;pie-chart&quot; width=&quot;300&quot; height=&quot;225&quot;&gt;&lt;/canvas&gt;</code></p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        ...
                        <div class="canvas-container">
                            <canvas id="pie-chart" width="300" height="225"></canvas>
                        </div>
        ...
        <div class="col-md-6">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Donut Chart</h3>
                        <p>Chart js donut chart <code>&lt;canvas id=&quot;donut-chart-area&quot; width=&quot;300&quot; height=&quot;225&quot;&gt; &lt;/canvas&gt;</code></p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        ...
                        <div class="canvas-container">
                            <canvas id="donut-chart-area" width="300" height="225"> </canvas>
                        </div>
        ...
        <div class="col-md-6">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Bar Chart</h3>
                        <p>Chart Js bar chart <code>&lt;canvas id=&quot;stacked-canvas&quot; height=&quot;410&quot; width=&quot;500&quot;&gt;&lt;/canvas&gt;</code></p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        ...
                        <div class="canvas-container">
                            <canvas id="stacked-canvas" height="410" width="500"></canvas>
                        </div>
        ...
        <div class="col-md-6">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Stacked Chart</h3>
                        <p>Chart js stacked bar chart <code>&lt;canvas id=&quot;bar-canvas&quot; height=&quot;410&quot; width=&quot;500&quot;&gt;&lt;/canvas&gt;</code></p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <div class="canvas-container">
                            <canvas id="bar-canvas" height="410" width="500"></canvas>
                        </div>
                    </div>
                </div>
            </div>
...
<!--Chart.Js-->
<script src="js/lib/chart/chart-js/chart.js"></script>
<script src="js/lib/chart/chart-js/chart.stackedbar.js"></script>
<script src="js/lib/chart.js.init.js"></script>
