...
$get_title = mysql_query("SELECT * FROM `service_place` where id='$id'");
    ...
    <div class="modal-dialog" style="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    <form class="form-horizontal" role="form" action="update_zone_place_north.php" method="post">

                        <div class="form-group">
                            <label class="col-md-2 control-label">Place</label>
                            <div class="col-md-10">
                                <input name="edit_ct" class="form-control" rows="5" value="<?php echo $fetch_profile['place']; ?>">	                                                </div>
                        </div>
