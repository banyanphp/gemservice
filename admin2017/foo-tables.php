...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-6">
            <h2>Tables</h2>
            <p>Responsive FooTable plugins</p>
        </div>
        <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="widget-header">
                                    <h3>Sortable FooTable</h3>
                                    <p>
                                        Sortable responsive jquery FooTable
                                    </p>
                                </div>
                            </div>
                ...
                <div class="widget-content">
                    <div class="data-action-bar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="widget-header">
                                    <h3>Sortable & Filterable FooTable</h3>
                                    <p>
                                        Sortable & Filterable responsive jquery FooTable with clear filter
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="data-align-right">
                                    ...
                                    <a href="#add" class="btn add-row btn-primary">Add New</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <span class="tfh-label">By Status: </span>
                ...
                <div class="widget-content">
                    <table class="table table-bordered foo-data-table">
                        ...
                        <tr>
                            ...
                            <th data-hide="all">NID</th>
                            <th class="td-center">Action</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>Rudyard Whitley</td>
                            <td>624-7780 Non, Road</td>
                            <td>4405051830469751</td>
                            <td class="td-center">
                        ...
                        <tr>
                            <td>Russell Sloan</td>
                            <td>P.O. Box 267, 5182 Orci. Rd.</td>
                            <td>4485239190970475</td>
                            <td class="td-center">
                                <div class="btn-toolbar">
                                    <div class="btn-group btn-group-sm">
                                        <button type="button" class="btn btn-link">Edit</button>
                        ...
                        <tr>
                            <td>Declan Donovan</td>
                            <td>Ap #268-599 Vel, Rd.</td>
                            <td>4539479373451</td>
                            <td class="td-center">
                                <div class="btn-toolbar">
                                    <div class="btn-group btn-group-sm">
                        ...
                        <tr>
                            <td>Alfonso Castillo</td>
                            <td>Ap #921-9365 Ante St.</td>
                            <td>4024007170299</td>
                            <td class="td-center">
                                <div class="btn-toolbar">
                                    <div class="btn-group btn-group-sm">
                        ...
                        <tr>
                            <td>Holmes Mckinney</td>
                            <td>Ap #312-8681 Dolor Street</td>
                            <td>4929302369494653</td>
                            <td class="td-center">
                                <div class="btn-toolbar">
                                    <div class="btn-group btn-group-sm">
                                        <button type="button" class="btn btn-link">Edit</button>
            ...
            <div class="widget-container">
                <div class="widget-content">
                    <table class="table table-bordered foo-data-table">
                        ...
                        <tr>
                            <td>Amery Porter</td>
                            <td><span class="label label-default">Basic</span></td>
                            <td class="td-right">
                                <div class="btn-toolbar">
                                    <div class="btn-group btn-group-sm">
                                        <button type="button" class="btn btn-default"><i class="zmdi zmdi-edit"></i></button>
                                        <button type="button" class="btn btn-default"><i class="zmdi zmdi-close"></i></button>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>Wyatt Ruiz</td>
                            <td><span class="label label-info">Uppper</span></td>
                            <td class="td-right">
                                <div class="btn-toolbar">
                                    <div class="btn-group btn-group-sm">
                                        <button type="button" class="btn btn-default"><i class="zmdi zmdi-edit"></i></button>
