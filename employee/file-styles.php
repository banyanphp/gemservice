                        ...
                        <div class="widget-content">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Default file input</label>
                                    <div class="col-md-8">
                                        <input type="file" class="filestyle bootstrap-file">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">File style without input</label>
                                    <div class="col-md-8">
                                        <input type="file" class="filestyle bootstrap-file" data-input="false">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">File style without icon</label>
                                    <div class="col-md-8">
                                        <input type="file" class="filestyle bootstrap-file" data-icon="false">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">File style with custom text</label>
                                    <div class="col-md-8">
                                        <input type="file" class="filestyle bootstrap-file" data-buttontext="Select file">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">File style with button style</label>
                                    <div class="col-md-8">
                                        <input type="file" class="filestyle bootstrap-file" data-buttonname="btn-primary">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Small file style</label>
                                    <div class="col-md-8">
                                        <input type="file" class="filestyle bootstrap-file" data-size="sm">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">File style with custom icon</label>
                                    <div class="col-md-8">
                                        <input type="file" class="filestyle bootstrap-file" data-iconname="fa-cloud-upload">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">File style before button</label>
                                    <div class="col-md-8">
