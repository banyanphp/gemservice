...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-6 col-sm-6">
            <h2>NVD3 Charts</h2>
            <p>Highly customizable Nvd3 svg charts</p>
        </div>
        <div class="col-md-6 col-sm-6">
        ...
        <div class="col-md-12">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Line Chart</h3>
                        <p>NVD3 multiple type line chart <code>id="nvd-line"</code> </p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <div id="nvd-line" class="nvd3-chart">
        ...
        <div class="col-md-12">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Combine Chart</h3>
                        <p>NVD3 bar and line combine chart <code>id="nvd-barline-chart"</code></p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <div id="nvd-barline-chart">
                            <svg></svg>
                        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Historical Bar Chart</h3>
                        <p>NVD3 historical bar chart<code>id="nvd-historical-bar"</code></p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <svg id="nvd-historical-bar" class="nvd3-chart">
        ...
        <div class="col-md-12">
            <div class="widget-wrap">
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    <div class="pull-left">
                        <h3>Stacked Chart</h3>
                        <p>NVD3 stacked area chart</p>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <div id="nvd-stack-chart" class="nvd3-chart">
                            <svg></svg>
                        </div>
...
<!--nv.d3 Chart-->
<script src="js/lib/chart/nvd3/d3.js"></script>
<script src="js/lib/chart/nvd3/nv.d3.js"></script>
<script src="js/lib/stream-layers.js"></script>
<script src="js/lib/nv.d3.init.js"></script>
