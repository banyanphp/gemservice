                                ...
                                <div class="col-md-6">
                                    <div class="data-align-right">
                                        <div class="tbl-action-toolbar">
                                            <ul>
                                             <a href="export_list_complaints_register.php" class="btn btn-info " ><i class="zmdi zmdi-archive"></i> Export Excel</a>
...
$team=$_SESSION['team'];
$sql = "SELECT * FROM complaints_2017 where  team in ($team) and service_engineer_allotment!='Yes'  order by complaint_no ";
...
?>
                            <tr>
							 <td><?php echo $sl; ?></td>
                                ...
                                <td class="td-right"><a class="row-edit" href="update_complaint.php?appid=<?php echo $query['id']; ?>"><span class="zmdi zmdi-edit"></span></a>
