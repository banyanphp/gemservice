        ...
        <div class="tile-leftbar">
            <div class="tile-row clearfix">
                ...
                <div class="tile-col-2 w_bg_amber">
                    <a href="#">
                        <span class="tile-nav-icon"><i class="zmdi zmdi-shopping-basket"></i></span>
                        <span class="tile-nav-title">Order</span>
                    </a>
                </div>
                <div class="tile-col-2 w_bg_green">
                    <a href="#">
                        <span class="tile-nav-icon"><i class="zmdi zmdi-ticket-star"></i></span>
                        <span class="tile-nav-title">Tickets</span>
                    </a>
                </div>
                <div class="tile-col-2 w_bg_light_blue">
                    <a href="#">
                        <span class="tile-nav-icon"><i class="zmdi zmdi-inbox"></i></span>
                        <span class="tile-nav-title">Mailbox</span>
                    </a>
                </div>
                <div class="tile-col-2 w_bg_purple">
                    <a href="#">
                        <span class="tile-nav-icon"><i class="zmdi zmdi-chart"></i></span>
                        <span class="tile-nav-title">Analytics</span>
                    </a>
                </div>
                <div class="tile-col-1 w_bg_cyan">
                    <a href="#">
                        <span class="tile-nav-icon"><i class="zmdi zmdi-truck"></i></span>
                        <span class="tile-nav-title">Order Shipped</span>
                    </a>
                </div>
                <div class="tile-col-2 w_bg_red">
                    <a href="#">
                        <span class="tile-nav-icon"><i class="zmdi zmdi-money"></i></span>
                        <span class="tile-nav-title">Earnings</span>
                    </a>
                </div>
                <div class="tile-col-2 w_bg_lime">
                    <a href="#">
                        <span class="tile-nav-icon"><i class="zmdi zmdi-phone-msg"></i></span>
                        <span class="tile-nav-title">Contact</span>
                    </a>
                </div>
                <div class="tile-col-2 w_bg_brown">
                    <a href="#">
                        <span class="tile-nav-icon"><i class="zmdi zmdi-file-text"></i></span>
                        <span class="tile-nav-title">Pages</span>
                    </a>
                </div>
            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    <div class="widget-header">
                        <h3>Tile Sidebar Code Structure</h3>
                        <p>
