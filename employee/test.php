...
$target_path = "../send_quote_spares/".$file_name;
		...
		move_uploaded_file($temp_name, $target_path);
		 ...
		 echo "update comp_process_2017 set send_quote_for_spares = '$img_name', send_quote_for_spares_descr = '$send_quote_spares' where comp_no = '$query_4_compno'";
...
<input type="hidden" name="query_12_id" value="<?php echo $chk_comp_result['id'] ?>">
 ...
 <?php } if($chk_comp_result['get_po'] == 'no') {	 ?>
...
$target_path = "../po_for_spares/".$file_name;
		...
		move_uploaded_file($temp_name, $target_path);
				...
				// $date_timestamp = date('Y-m-d H:i:s',strtotime('+330 minute')); // call attending time
									mysql_query("update comp_process_2017 set get_po = '$img_nameimg_name', get_po_descr = '$get_po_spares' where comp_no = '$query_5_compno'");
