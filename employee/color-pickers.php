            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page"> Colors pickers</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="widget-content">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Bootstrap Color Picker</label>
                                    <div class="col-md-7">
                                        <input type="text" class="demo1 form-control" value="#4dd0e1"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Color Picker</label>
                                    <div class="col-md-7">
                                        <div class="input-group demo2">
                                            <input type="text" value="#4dd0e1" class="form-control"/>
                        ...
                        <div class="widget-content">
                           <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Color Picker</label>
                                    <div class="col-md-7">
                                        <input class="color no-alpha form-control" value="#cfd8dc"/>
                                    </div>
                                </div>
                            </form>
                            <h3>Dependent Files &amp; Codes</h3>
