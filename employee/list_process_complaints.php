                                    ...
                                    <div class="data-align-right">
                                        <div class="tbl-action-toolbar">
                                            <ul>
                                                ...
                                                <a href="export_proceess_complaints.php" class="btn btn-info " ><i class="zmdi zmdi-archive"></i> Export Excel</a>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
$sl=0;$code=$_SESSION['emp_code'];
$sql = "SELECT * FROM complaints_2017 where status='Process' and ser_eng_code='$code' order by complaint_no";
...
?>
                            <tr>
							 <td><?php echo $sl; ?></td>
                                ...
                                <td><a href="#"><?php echo $query['complaint_date']; ?></a></td>
                               
                                <td data-value="1"><a class="label label-success"  title="Active" href="complaint.php?id=<?php echo $query['id']; ?>">Details</span></a></td>
