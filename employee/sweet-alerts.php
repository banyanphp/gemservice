...
<div class="widget-content">
    <div class="row">
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
            <button class="btn btn-default btn-block simple-alert"><i class="icon-play"></i> Alert</button>
        </div>
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
            <button class="btn btn-default btn-block success-alert"><i class="icon-play"></i> Success Alert</button>
        </div>
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
            <button class="btn btn-default btn-block warning-btn-ok"><i class="icon-play"></i>Ok Message</button>
        </div>
    </div>
    <div class="row">
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
            <button class="btn btn-default btn-block warning-prompt"><i class="icon-play"></i> Prompt Alert</button>
        </div>
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
            <button class="btn btn-default btn-block warning-custom-icon"><i class="icon-play"></i> Custom Icon</button>
        </div>
        <div class=" col-md-4 col-sm-4 margin-bottom-10">
            <button class="btn btn-default btn-block warning-custom-html"><i class="icon-play"></i> Custom Html </button>
        </div>
    </div>
    <div class="row">
        <div class=" col-md-6 col-sm-6 margin-bottom-10">
            <button class="btn btn-default btn-block warning-auto-close"><i class="icon-play"></i> Alert Auto Close</button>
        </div>
        <div class=" col-md-6 col-sm-6 margin-bottom-10">
            <button class="btn btn-default btn-block warning-btn-cancel"><i class="icon-play"></i> With Cancel Message </button>
        </div>
    </div>
