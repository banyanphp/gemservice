...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-6 col-sm-6">
            <h2>Calendar</h2>
            <p>Event calendar with envent add system</p>
        </div>
        <div class="col-md-6 col-sm-6">
            <ul class="list-page-breadcrumb">
                <li><a href="#">Home <i class="zmdi zmdi-chevron-right"></i></a></li>
                <li class="active-page"> Calendar</li>
            </ul>
        </div>
    </div>
</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="select-cal-view">
                                    <div class="btn-group">
                                        <button class="btn btn-primary CalMonthView">Month</button>
                                        <button class="btn btn-primary CalAgendaWeekView">Week</button>
                                        <button class="btn btn-primary CalAgendaDayView">Day</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4">
