                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="widget-header">
                                        <h3 style="font-weight: 900;">Completed Complaints List</h3>
                                ...
                                <div class="col-md-6">
                                    <div class="data-align-right">
                                        <div class="tbl-action-toolbar">
                                            <ul>
                                            <a href="export_list_complaints_register_completed.php" class="btn btn-info " ><i class="zmdi zmdi-archive"></i> Export Excel</a>
...
$team=$_SESSION['team'];
$sql = "SELECT * FROM complaints_2017 where status='Completed' and team  in ($team) order by complaint_no ";
