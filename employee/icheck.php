            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    <div class="widget-header block-header">
                        <h3>Icheck </h3>
                        <p>Stylish checkbox and radio </p>
                    </div>
                    <div class="widget-container">
                        <div class="widget-content">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="margin-top-0">Checkboxes</h3>
                                    <div class="icheck-input">
                                        <input class="i-min-check" type="checkbox" id="minimal-checkbox-1">
                                        <label for="minimal-checkbox-1">Nam ut tempor lacus,</label>
                                    </div>
                                    <div class="icheck-input">
                                        <input class="i-min-check" type="checkbox" id="minimal-checkbox-2">
                                        <label for="minimal-checkbox-2">Vestibulum ante ipsum primis.</label>
                                    </div>
                                    <div class="icheck-input">
                                        <input class="i-min-check" type="checkbox" id="minimal-checkbox-3" disabled checked>
                                        <label for="minimal-checkbox-3">Disabled Checkbox.</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h3 class="margin-top-0">Radio</h3>
                                    <div class="icheck-input">
                                        <input name="radio-group" class="i-min-check" type="radio" id="minimal-radio-1" checked>
                                        <label for="minimal-radio-1"> Phasellus rhoncus sapien id auctor iaculis.</label>
                                    </div>
                                    <div class="icheck-input">
                                        <input name="radio-group" class="i-min-check" type="radio" id="minimal-radio-3" disabled checked>
                                        <label for="minimal-radio-3"> Disabled Radio.</label>
                                    </div>
                                    <div class="icheck-input">
                                        <input name="radio-group" class="i-min-check" type="radio" id="minimal-radio-4">
