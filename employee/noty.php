...
<div class="widget-content">
    <div class="row">
        <div class="col-md-4 col-sm-4">
            <button class="btn btn-default btn-block ex-noty" data-layout="topLeft" data-type="warning">Noty (TopLeft)</button>
        </div>
        <div class="col-md-4 col-sm-4">
            <button class="btn btn-default btn-block ex-noty" data-layout="topCenter" data-type="success">Noty (TopCenter)</button>
        </div>
        <div class="col-md-4 col-sm-4">
            <button class="btn btn-default btn-block ex-noty" data-layout="topRight" data-type="information">Noty (TopRight)</button>
        </div>
    </div>
    <div class="row">

        <div class="col-md-4 col-sm-4">
            <button class="btn btn-default btn-block ex-noty" data-layout="centerLeft" data-type="alert">Noty (CenterLeft)</button>
        </div>
        <div class="col-md-4 col-sm-4">
            <button class="btn btn-default btn-block ex-noty" data-layout="center" data-type="information">Noty (Center)</button>
        </div>
        <div class="col-md-4 col-sm-4">
            <button class="btn btn-default btn-block ex-noty" data-layout="centerRight" data-type="alert">Noty (CenterRight)</button>
        </div>
    </div>
    <div class="row">

        <div class="col-md-4 col-sm-4">
            <button class="btn btn-default btn-block ex-noty" data-layout="bottomLeft" data-type="success">Noty (BottomLeft)</button>
        </div>
        <div class="col-md-4 col-sm-4">
            <button class="btn btn-default btn-block ex-noty" data-layout="bottomCenter" data-type="warning">Noty (BottomCenter)</button>
        </div>
        <div class="col-md-4 col-sm-4">
            <button class="btn btn-default btn-block ex-noty" data-layout="bottomRight" data-type="error">Noty (BottomRight)</button>
        </div>
    </div>
