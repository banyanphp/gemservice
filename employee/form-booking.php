            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    <div class="widget-header block-header">
                        <h3>Booking Form</h3>
                        <p>A example of ooking form validation</p>
                    </div>
                        ...
                        <div class="widget-content">
                            <form action="http://lab.westilian.com/westilo-admin/material-style-sidebar/php/demo.php" method="post" class="j-forms" id="j-forms" novalidate>
                                ...
                                <div class="form-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 unit">
                                            <div class="input">
                                                ...
                                                <input class="form-control" type="text" placeholder="Adult guests" id="adults" name="adults">
                                        ...
                                        <div class="col-md-6 unit">
                                            <div class="input">
                                                ...
                                                <input class="form-control" type="text" placeholder="Children guests" id="children" name="children">
                                    ...
                                    <div class="j-row">
                                        <div class="col-md-6 unit">
                                            <div class="input">
                                                ...
                                                <input class="form-control" type="text" placeholder="Check-in date" id="date_from" name="date_from">
                                            </div>
                                        </div>
                                        <div class="col-md-6 unit">
                                            <div class="input">
                                                ...
                                                <input class="form-control" type="text" placeholder="Check-out date" id="date_to" name="date_to">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end date -->
                                    ...
                                    <div class="unit">
                                        <div class="input">
                                            <textarea class="form-control" placeholder="Your questions and comments..." spellcheck="false" name="message"></textarea>
                                        </div>
                                    </div>
                                    <!-- end message -->
                                ...
                                <div class="form-footer">
                                    <button type="submit" class="btn btn-success primary-btn">Booking</button>
                                </div>
                                <!-- end /.footer -->
