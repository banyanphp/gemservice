    ...
    <div class="topbar-right pull-right">
        <div class="clearfix">
            ...
            <ul class="pull-right top-right-icons">
                ...
                <li class="dropdown more-dropdown topbar-logged-user"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="images/avatar/robertoortiz.jpg" alt="admin"></a>
                    <div class="dropdown-menu more-apps">
                        <div class="user-profile-container">
                            <div class="user-profile clearfix">
                                <div class="admin-user-thumb">
                                    <img src="images/avatar/robertoortiz.jpg" alt="admin">
                                </div>
...
<section class="main-container">
    <div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    <h2>Topbar Logged User Thumb</h2>
                    <p>Logged user info with thumbnail in topbar</p>
                </div>
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        <li><a href="#">Home <i class="zmdi zmdi-chevron-right"></i></a></li>
                        <li><a href="#">Layout <i class="zmdi zmdi-chevron-right"></i></a></li>
                        <li class="active-page"> Topbar User Thumb</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="widget-wrap">
                    ...
                    <div class="widget-container">
                        <div class="widget-content">
                                            ...
                                            ...
                                                        &lt;li class=&quot;dropdown more-dropdown topbar-logged-user&quot;&gt; // Code Start Here
                                                           ...
                                                            &lt;div class=&quot;dropdown-menu more-apps&quot;&gt;
                                                                &lt;div class=&quot;user-profile-container&quot;&gt;
                                                                    &lt;div class=&quot;user-profile clearfix&quot;&gt;
                            ...
                            <pre class="code language-html">
                                            ...
                                            &lt;div class=&quot;topbar-right pull-right&quot;&gt;
                                                &lt;div class=&quot;clearfix&quot;&gt;
                                                    ...
                                                    &lt;ul class=&quot;pull-right top-right-icons&quot;&gt;
                                                        &lt;li&gt;...&lt;/li&gt;
                                                        &lt;li class=&quot;dropdown notifications-dropdown&quot;&gt;...&lt;/li&gt;
                                                        &lt;li&gt;...&lt;/li&gt;
                                                        &lt;li class=&quot;dropdown more-dropdown topbar-logged-user&quot;&gt; // Code Start Here
                                                           ...
                                                            &lt;div class=&quot;dropdown-menu more-apps&quot;&gt;
