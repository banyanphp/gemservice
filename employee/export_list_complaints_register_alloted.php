<?php
include ("db/db_connect.php");session_start();
...
header("Content-Disposition: attachment; filename=Pending complaints.xls");
?>
<style>
table>th{
...
<?php if($row['comp_attending_date']!='') {  ?>
   ...
   <td><?php echo date('d-m-Y', strtotime($row['comp_attending_date'])); ?></td>                                               
<?php } else{ ?>   <td></td>                                               
<?php } ?>
...
<?php echo date('d-m-Y', strtotime($row['comp_closing_date'])); ?></td> <?php } else { ?>   <td></td>                                               
<?php } ?>
