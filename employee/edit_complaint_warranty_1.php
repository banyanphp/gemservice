                                ...
                                <div class="col-md-6">
                                    <form class="form-horizontal" id="addcity">
									   <div class="form-group">
                                            <label class="col-md-4 control-label"> IS any Spares Required</label>
                                            <div class="col-md-8">
                                                <select class="form-control"  name="spares_req_eng" id="call">
...
var ids = $("#ids").val();
        if (username == '0')
        {
            $('#errors').html('Please Select spares required');
            $("#call").focus();
...
$.ajax({
type : 'POST',
url : 'update_complaint_process_2.php',
data : data,
beforeSend: function(){
$("#errors").html('');
...
window.location.href='edit_complaint_warranty_3.php?id='+ ids;
  }
  else{
	 // $("#errors").html(response);

$("#errors").html("Error Occured ");
window.location.href='edit_complaint_warranty_4.php?id='+ ids;
