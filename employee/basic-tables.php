            ...
            <div class="col-md-6">
                <div class="widget-wrap">
                    <div class="widget-header block-header clearfix">
                        <h3>Table</h3>
                        <p>
                            Use <code>class="table"</code> for this table styles
                        </p>
                    </div>
            ...
            <div class="col-md-6">
                <div class="widget-wrap">
                    <div class="widget-header block-header clearfix">
                        <h3>Striped Table</h3>
                        <p>
                            Use <code>class="table table-striped"</code> for this table styles
                        </p>
                    </div>
                    <div class="widget-container">
                        <div class="widget-content">
            ...
            <div class="col-md-6">
                <div class="widget-wrap">
                    <div class="widget-header block-header clearfix">
                        ...
                        <p>
                            Use <code>class="table table-bordered"</code> for this table styles
                        </p>
                    </div>
                    <div class="widget-container">
                        <div class="widget-content">
            ...
            <div class="col-md-6">
                <div class="widget-wrap">
                    <div class="widget-header block-header clearfix">
                        ...
                        <p>
                            Use <code>class="table table-hover"</code> for this table styles
                        </p>
                    </div>
                    <div class="widget-container">
                        <div class="widget-content">
            ...
            <div class="col-md-6">
                <div class="widget-wrap">
                    <div class="widget-header block-header clearfix">
                        ...
                        <p>
                            Use <code>.active .success .warning .danger .info</code> in <code>tr</code> or <code>td</code>
                        </p>
                    </div>
                    <div class="widget-container">
                        <div class="widget-content">
