...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-6">
            <h2>Currency Formated Elements</h2>
            <p>All currency formated form elements</p>
        </div>
        <div class="col-md-6">
...
<div class="widget-wrap">
    <div class="widget-header block-header clearfix">
        <div class="pull-left">
            ...
            <p>All example of currency formated elements</p>
        </div>
                ...
                <div class="col-md-12">
                    <form action="#" class="j-forms" novalidate>
                        ...
                        <div class="form-content">
                            ...
                            <div class="w-section-header"><h3>Numeric separator</h3></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 unit">
                                    ...
                                    <div class="input">
                                        ...
                                        <input type="text" id="coma" class="currency form-control">
                                    </div>
                                </div>
                                <div class="col-md-6 unit">
                                    ...
                                    <div class="input">
                                        ...
                                        <input type="text" id="apostrophe" class="currency form-control" data-a-dec="." data-a-sep="'">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 unit">
                                    ...
                                    <div class="input">
                                        ...
                                        <input type="text" id="space" class="currency form-control" data-a-dec="." data-a-sep=" ">
                                    </div>
                                </div>
                            </div>
                            <!-- end period space -->

                            <div class="w-section-header"><h3>Currency signs</h3></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 unit">
                                    ...
                                    <div class="input">
                                        <input type="text" class="currency form-control" data-a-sign="$ ">
                                    </div>
                                </div>
                                <div class="col-md-6 unit">
                            ...
                            <div class="w-section-header"><h3>Select your currency</h3></div>

                            <!-- start currency input -->
                            <div class="unit">
                                <div class="input">
                                    <input class="form-control" type="text" placeholder="enter the amount" id="input-select-currency">
                                </div>
                            </div>
                            <!-- end currency input -->

                            <!-- start inline currency radio -->
                            <div class="unit">
                                <div class="inline-group" id="radio-select-currency">
                                    <label class="radio">
                                        <input type="radio" name="currency" checked="" value="dollar">
                                        <i></i>
                                        $ - US Dollar
                                    </label>
                                    <label class="radio">
                                    ...
                                    <label class="radio">
                                        <input type="radio" name="currency" value="yen">
                                        <i></i>
                                        ¥ - Yen
                                    </label>
                                </div>
                            </div>
                            <!-- end inline currency radio -->

                            <div class="w-section-header"><h3>Range values</h3></div>

                            <!-- start range values -->
                            <div class="row">
                                <div class="col-md-6 unit">
                                    <div class="input">
                                        <input type="text" class="currency form-control" placeholder="0 - 5000.00" data-v-max="5000.00" data-v-min="0">
                                    </div>
                                </div>
                                <div class="col-md-6 unit">
                                    <div class="input">
                                        <input type="text" class="currency form-control" placeholder="-1000.00 - 1000.00" data-v-min="-1000.00" data-v-max="1000.00">
                                    </div>
                                </div>
                            </div>
                            <!-- end range values -->
