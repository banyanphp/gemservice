...
$sl=0;
$sql = "SELECT * FROM service_engineers where zoneid = '4' order by zoneid";
...
?>
                            <tr>
							 <td><?php echo $sl; ?></td>
                                <td><?php echo $query['engineers']; ?></td>
                           <td><?php $place = $query['placeid']; $query_place1 = mysql_query("select * from service_place where id = '$place'"); $query_place_res1 = mysql_fetch_array($query_place1); echo $query_place_res1['place']; ?></td> 
				
                               
                                 <td data-value="1"><a class="label label-success"  title="Active" href="place_details.php?id=<?php echo $query['id']; ?>">Details</span></a></td>
  ...
  <script language="JavaScript" type="text/javascript">
            function fndelete(id) {
                ...
                if (result)
                {
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'delete_zone_place_north.php',
                        data: {
                            id: id,
                        },
		 ...
		 <script language="JavaScript" type="text/javascript">
            function update(id) {
                ...
                $.ajax({
                    type: "POST",
                    url: 'view_zone_place_service_north.php',
                    data: {
                        id: id,
                    },
                    success: function (data)
