        ...
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p>A call me form validation with captcha</p>
                </div>
                <div class="col-md-6">
            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    <div class="widget-header block-header">
                        <h3>Callback form</h3>
                        <p>Callback form with captcha validation</p>
                    </div>
                    <div class="widget-container">
                        <div class="widget-content">
                            <form action="http://lab.westilian.com/westilo-admin/material-style-sidebar/php/demo.php" method="post" class="j-forms" id="j-forms-captcha" novalidate>
                                ...
                                <div class="form-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 unit">
                                            ...
                                            <div class="input">
                                                ...
                                                <input class="form-control" type="text" placeholder="telephone or mobile" id="phone" name="phone">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end name phone -->
                                    ...
                                    <div class="unit">
                                        ...
                                        <label class="input select">
                                            <select autocomplete="off" name="time" class="form-control">
                                    ...
                                    <div class="unit">
                                        ...
                                        <div class="input">
                                            <textarea class="form-control" spellcheck="false" name="message"></textarea>
                                        </div>
                                    </div>
                                    <!-- end textarea -->
                                    ...
                                    <div class="unit">
                                        ...
                                        <div class="captcha-group">
                                            <div class="input">
                                                ...
                                                <input  class="form-control captcha-input" type="text" id="captcha_code" name="captcha_code" placeholder="solve the captcha">
                                                <span class="tooltip tooltip-right-top">Enter sum of the digits</span>
                                            </div>
                                            <label class="captcha" for="captcha_code">
                                                <img src="php/captcha/captcha-image.png" alt="captcha" />
                                            </label>
                                        </div>
                                    </div>
                                    <!-- end captcha -->
                                ...
                                <div class="form-footer">
                                    <button type="submit" class="btn btn-success primary-btn">Call Me</button>
                                </div>
                                <!-- end /.footer -->
