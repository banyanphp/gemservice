            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page"> Spinner</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    <div class="widget-header block-header clearfix">
                        ...
                        <p> jQuery bootstrap touch spinner</p>
                    </div>
                    <div class="widget-container">
                        <div class="widget-content">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class=" col-md-4 control-label">Vertical button alignment:</label>
                                    <div class=" col-md-8">
                                        <input class="vertical-spin" type="text" value="" name="vertical-spin">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Using data attributes</label>
                                    <div class="col-md-8">
                                        <input id="demo0" type="text" value="55" name="demo0" data-bts-min="0" data-bts-max="100" data-bts-init-val="" data-bts-step="1" data-bts-decimal="0" data-bts-step-interval="100" data-bts-force-step-divisibility="round" data-bts-step-interval-delay="500" data-bts-prefix="" data-bts-postfix="" data-bts-prefix-extra-class="" data-bts-postfix-extra-class="" data-bts-booster="true" data-bts-boostat="10" data-bts-max-boosted-step="false" data-bts-mousewheel="true" data-bts-button-down-class="btn btn-default" data-bts-button-up-class="btn btn-default"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Example with postfix (large)</label>
                                    <div class="col-md-8">
                                        <input id="demo1" type="text" value="55" name="demo1">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">With prefix </label>
                                    <div class="col-md-8">
                                        <input id="demo2" type="text" value="0" name="demo2" class=" form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Init with empty value:</label>
                                    <div class="col-md-8">
                                        <input id="demo3" type="text" value="" name="demo3">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Value attribute is not set (applying settings.initval)</label>
                                    <div class="col-md-8">
                                        <input id="demo3_21" type="text" value="" name="demo3_21">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Value is set explicitly to 33 (skipping settings.initval) </label>
                                    <div class="col-md-8">
                                        <input id="demo3_22" type="text" value="33" name="demo3_22">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Button group</label>
                                    <div class="col-md-8">
