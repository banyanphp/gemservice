...
$chk_comp_result = mysql_fetch_array($chk_comp);
 $chk_comp_result['spares_required_one'];
?>
        <div class="row">
            <div class="col-md-12">
		  ...
		  <?php if(isset($_POST['submit'])) { 
			  ...
			  echo "update complaints_2017 set warranty_set = '$spares_req', comp_attending_date = '$comp_attending' where id = '$query_1_id'"; 
...
echo "<script>window.location.href='service_part_warranty_set1.php?appid=$compid'</script>";
	}?>
