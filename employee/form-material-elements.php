            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    <div class="widget-header margin-bottom-0 block-header clearfix">
                        <div class="pull-left">
                            <h3>Section header in form</h3>
                            <p>Section header with subtitle in widget or form  </p>
                        </div>
                        <div class="pull-right w-action">
                            <ul class="widget-action-bar">
                                <li class="dropdown">
                    ...
                    <div class="widget-container">
                        <div class="widget-content">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form role="form" class="material-form">
                                        <div class="controls">
