...
<?php include ("db/db_connect.php"); $id=$_GET['id']; ?>
  ...
  <tr>
    ...
    <td width="80%" height="35" align="center" bgcolor="#FFFFFF">
	<table width="75%" border="0" cellpadding="0" cellspacing="0" class="border_all_dealer">
      <tr>
        <td height="35">&nbsp;</td>
        <td>
		<table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="34%" height="35" align="left" valign="top"><?php $x = mysql_query("select * from service_engineers where id = '$id'");
			$y = mysql_fetch_array($x); ?></td>
            <td width="4%" height="35" align="left" valign="top">&nbsp;</td>
            <td width="62%" height="35" colspan="2" align="right" valign="middle"><form><input type="button"  class="btn btn-danger" onclick="window.history.go(-1)" value="Back" />
                      </form></td>
          </tr>
           <tr class="title">
              <td height="35" align="left" valign="middle">Zone</td>
              <td height="35" align="left" valign="middle">&nbsp;</td>
              <td height="35" colspan="2" align="left" valign="middle"><?php $zone = $y['zoneid']; $query_place = mysql_query("select * from service_zone where id = '$zone'"); $query_place_res = mysql_fetch_array($query_place); echo $query_place_res['zone'];?></td></td>
            </tr>
			  <tr class="title">
            <td height="65" align="left" valign="middle">PLACE</td>
            <td height="65" align="left" valign="middle">:</td>
            <td height="65" colspan="2" align="left" valign="middle"><?php $place = $y['placeid']; $query_place1 = mysql_query("select * from service_place where id = '$place'"); $query_place_res1 = mysql_fetch_array($query_place1); echo $query_place_res1['place']; ?> </td>
          </tr>
          <tr class="title">
            <td height="35" align="left" valign="middle">Employee Name</td>
            <td height="35" align="left" valign="middle">&nbsp;</td>
            <td height="35" colspan="2" align="left" valign="middle"><?php echo $y['engineers']; ?></td>
          </tr>
          
            <tr class="title">
              <td height="35" align="left" valign="middle">Employee Code</td>
              <td height="35" align="left" valign="middle">&nbsp;</td>
              <td height="35" colspan="2" align="left" valign="middle"><?php echo $y['eng_code']; ?></td>
            </tr>
            <tr class="title">
              <td height="35" align="left" valign="middle">Employee Email</td>
              <td height="35" align="left" valign="middle">&nbsp;</td>
