...
<section class="main-container">
    <div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    <h2>Clone Form Elements</h2>
                    <p>All examples of clone form elements</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="widget-wrap">
                    <div class="widget-header block-header margin-bottom-0 clearfix">
                        <div class="pull-left">
                            ...
                            <p>All examples of form elements clone</p>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <form action="#" class="j-forms" novalidate>
                                    ...
                                    <div class="form-content">
                                        ...
                                        <div class="w-section-header"><h3>Cloning with widget addons</h3></div>
                                        <!-- start cloned widget element -->
                                        ...
                                        <!-- end cloned widget element -->

                                        <div class="w-section-header"><h3>Cloning with buttons</h3></div>
                                        ...
                                        <!-- start cloned left side buttons element -->
                                        <div class="clone-leftside-btn-1">
                                            ...
                                            <div class="j-row toclone-widget-left toclone">
                                                ...
                                                <button type="button" class="primary-btn clone-btn-left clone">
                                                    <i class="fa fa-plus"></i>
                                                </button>
                                        ...
                                        <div class="w-section-header"><h3>Cloning with links</h3></div>

                                        <!-- start cloned link elements -->
                                        <div class="clone-link">
                                            <div class="toclone">

                                                <a href="#" class="link clone"><i class="zmdi zmdi-plus"></i> Add new person</a>
                                                <a href="#" class="link delete"><i class="zmdi zmdi-delete"></i> Delete a person</a>
