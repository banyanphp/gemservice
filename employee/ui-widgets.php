...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-6 col-sm-6">
            <h2>Widgets</h2>
            <p>All type of UI widgets</p>
        </div>
        <div class="col-md-6 col-sm-6">
            <ul class="list-page-breadcrumb">
                <li><a href="#">Home <i class="zmdi zmdi-chevron-right"></i></a></li>
                <li class="active-page"> Widgets</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="weather-widget" id="weather">
    <div class="weather-widget-wall w_bg_cyan">
        ...
        <div class="weather-temperature">
            ...
            <div class="temperature">
                <div class="date-time">
                    <span class="w-date">18 SEP 2015</span>
                    <span class="w-day">FRI</span>
                </div>
                <div class="w-meter">
                    <span class="temperature-f">92°F</span>
                    <span class="temperature-c">32°C</span>
                </div>
            </div>
        </div>
    ...
    <div class="forecast">
        <div class="sun-r-s">
            <span><label>Sunrise:</label> 7:16 AM </span>
            <span><label>Sunset:</label> 7:30 PM </span>
        </div>
        <ul>

            <li>
                <span class="w-day">Sat</span>
                <span class="day-w-icon"> <i class="icon-1"></i></span>
                <span class="day-temperature">94</span>
            </li>
            <li>
                <span class="day">Sun</span>
                <span class="day-w-icon"> <i class="icon-1"></i></span>
                <span class="day-temperature">97</span>
            </li>
            <li>
                <span class="day">Mon</span>
                <span class="day-w-icon"> <i class="icon-1"></i></span>
                <span class="day-temperature">95</span>
            </li>
            <li>
                <span class="day">Tue</span>
                <span class="day-w-icon"> <i class="icon-1"></i></span>
                <span class="day-temperature">96</span>
            </li>
            <li>
