...
<div class="bb-alert alert alert-success">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
            <ul class="list-page-breadcrumb">
                ...
                <li class="active-page"> On/Off switch</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="widget-wrap">
            <div class="widget-header block-header margin-bottom-0 clearfix">
                <div class="pull-left">
                    ...
                    <p>jquery.switch.button.js On/Off switch </p>
                </div>
            ...
            <div class="widget-container">
                <div class="widget-content">
                    <div class="row margin-bottom-10">
                        <div class="col-md-6 col-sm-6">
                            <code>class="switch-mini"</code>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div class="padding-top-4">
                                <input class="switch-mini" type="checkbox" value="1" checked>
                            </div>
                        </div>
                    </div>
                    <div class="row margin-bottom-10">
                        <div class="col-md-6 col-sm-6">
                            <code>class="switch-sm"</code>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div>
                                <input class="switch-sm" type="checkbox" value="1" checked>
                            </div>
                        </div>
                    </div>
                    <div class="row margin-bottom-10">
                        <div class="col-md-6 col-sm-6 padding-top-2">
                            <code>class="switch-xs"</code>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div>
                                <input class="switch-xs" type="checkbox" value="1" checked>
                            </div>
                        </div>
                    </div>
                    <div class="row margin-bottom-10">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div>
                                <input class="switch-xs" type="checkbox" value="0">
                            </div>
                        </div>
                    </div>
                    <div class="row margin-bottom-10">
                        <div class="col-md-6 col-sm-6 padding-top-6">
                            <code>class="switch-large"</code>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div>
                                <input class="switch-large" type="checkbox" value="1" checked>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-6">
        <div class="widget-wrap">
            ...
            <div class="widget-container">
                <div class="widget-content">
                    <div class="row margin-bottom-10">
                        <label class=" col-md-4 control-label padding-top-10">Large</label>
                        <div class=" col-md-8">
                            <div class="input-group">
                                <input type="checkbox" class="switchery-large" checked/>
                            </div>
                        </div>
                    </div>
                    <div class="row margin-bottom-10">
                        <label class=" col-md-4 control-label padding-top-6">Medium</label>
                        <div class=" col-md-8">
                            <div class="input-group">
                                <input type="checkbox" class="switchery-m" checked/>
                            </div>
                        </div>
                    </div>
                    <div class="row margin-bottom-10">
                        <label class=" col-md-4 control-label padding-top-2">Small</label>
                        <div class=" col-md-8">
                            <div class="input-group">
                                <input type="checkbox" class="switchery-small" checked/>
                            </div>
                        </div>
                    </div>
                    <div class="row margin-bottom-10">
                        <label class=" col-md-4 control-label padding-top-6">Off</label>
                        <div class=" col-md-8">
                            <div class="input-group">
                                <input type="checkbox" class="switchery-m"/>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="js/lib/switchery.js"></script>
