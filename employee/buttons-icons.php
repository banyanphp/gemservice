...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-6 col-sm-6">
            <h2>Buttons &amp; Icons</h2>
            <p>All buttons &amp; icons with variations</p>
        </div>
        <div class="col-md-6 col-sm-6">
...
<div class="row">
    <div class="col-md-6">
        <div class="widget-wrap">
            <div class="widget-header block-header margin-bottom-0 clearfix">
                <div class="pull-left">
                    <h3>Button Group</h3>
                    <p>Button group with size &amp; variations</p>
                </div>
            </div>
            <div class="widget-container margin-top-0">
                <div class="widget-content">
    ...
    <div class="widget-header block-header margin-bottom-0 clearfix">
        <div class="pull-left">
            <h3>Toolbars &amp; Buttons</h3>
            <p>Large size block button &amp; toolbars</p>
        </div>
    </div>
    <div class="widget-container margin-top-0">
    <div class="widget-content">
        ...
        <div class="components-container">
            <div class="btn-toolbar">
                <div class="btn-group">
                    <a href="#" class="btn btn-default"><i class="zmdi zmdi-border-all"></i></a>
                    <a href="#" class="btn btn-default"><i class="zmdi zmdi-format-align-center"></i></a>
                    <a href="#" class="btn btn-default"><i class="zmdi zmdi-format-align-right"></i></a>
                    <a href="#" class="btn btn-default"><i class="zmdi zmdi-format-align-left"></i></a>
                </div>

                <div class="btn-group">
                    <a href="#" class="btn btn-default"><i class="zmdi zmdi-format-color-fill"></i></a>
                    <a href="#" class="btn btn-default"><i class="zmdi zmdi-format-ltr"></i></a>
                    <a href="#" class="btn btn-default"><i class="zmdi zmdi-format-bold"></i></a>
                </div>

                <div class="btn-group">
                    <a href="#" class="btn btn-default"><i class="zmdi zmdi-format-color-text"></i></a>
                    <div class="btn-group">
...
<div class="widget-header block-header margin-bottom-0 clearfix">
    <div class="pull-left">
        <h3>Iconic Button Group</h3>
        <p>Iconic button group with size &amp; variations</p>
    </div>
</div>
<div class="widget-container margin-top-0">
<div class="widget-content">
    ...
    <div class="row margin-bottom-10">
        <div class="col-md-2 col-sm-4">
            <div class="btn-group-ex-container">
                <div class="btn-group dropup">
                    <a href="#" class="btn btn-default">Default</a>
                    <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><i class="zmdi zmdi-format-color-fill"></i></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                        <li><a href="#">Something else here</a></li>
        ...
        <div class="col-md-2 col-sm-4">
            <div class="btn-group-ex-container">
                <div class="btn-group dropup">
                    <a href="#" class="btn btn-primary">Primary</a>
                    <a href="#" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><i class="zmdi zmdi-code-setting"></i></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                        <li><a href="#">Something else here</a></li>
        ...
        <div class="col-md-2 col-sm-4">
            <div class="btn-group-ex-container">
                <div class="btn-group dropup">
                    <a href="#" class="btn btn-success">Success</a>
                    <a href="#" class="btn btn-success dropdown-toggle" data-toggle="dropdown"><i class="zmdi zmdi-settings"></i></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                        <li><a href="#">Something else here</a></li>
        ...
        <div class="col-md-2 col-sm-4">
            <div class="btn-group-ex-container">
                <div class="btn-group dropup">
                    <a href="#" class="btn btn-info">Info</a>
                    <a href="#" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="zmdi zmdi-shopping-cart"></i></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                        <li><a href="#">Something else here</a></li>
        ...
        <div class="col-md-2 col-sm-4">
            <div class="btn-group-ex-container">
                <div class="btn-group dropup">
                    <a href="#" class="btn btn-danger">danger</a>
                    <a href="#" class="btn btn-danger dropdown-toggle" data-toggle="dropdown"><i class="zmdi zmdi-plus"></i></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                        <li><a href="#">Something else here</a></li>
    ...
    <div class="col-md-6">
        <div class="widget-wrap">
            <div class="widget-header block-header margin-bottom-0 clearfix">
                <div class="pull-left">
                    <h3>Font Awesome</h3>
                    <p>The complete set of 585 icons in Font Awesome</p>
                </div>
            </div>
            <div class="widget-container ">
                <div class="widget-content">

                 This template support font awesome icons you can use any icons from here <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank">Font Awesome</a>
        ...
        <div class="widget-wrap">
            <div class="widget-header block-header margin-bottom-0 clearfix">
                <div class="pull-left">
                    ...
                    <p>The complete set of 744 icons in Material Design Iconic Font.</p>
                </div>
            </div>
            <div class="widget-container">
                <div class="widget-content">

                    This template used material deisgn icons you can use any icons from here <a href="http://zavoloklom.github.io/material-design-iconic-font/icons.html" target="_blank">Material Design Iconic Font</a>
