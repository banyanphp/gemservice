...
$code=$_SESSION['emp_code'];
 $sql1 = "SELECT * FROM tbl_comp_process_2017 where process_status='Need Spares' and approve2='' and approve1='yes' order by id ";
$result1 = mysql_query($sql1);
while($query1 = mysql_fetch_array($result1)){
	$code=$query1['comp_no'];
	 $sql = "SELECT * FROM complaints_2017 where complaint_no='$code'";
...
?>
                            <tr>
							 <td><?php echo $sl; ?></td>
                                ...
                                <td data-value="1"><a class="label label-success"  title="Active" href="claim_details.php?id=<?php echo $query['id']; ?>">Details</span></a></td>
								<td data-value="1"><a class="label label-info" id="approve" title="Approval" href="javascript:void(0);" onclick="fnapprove(<?php echo $query1['id']; ?>)">Approve</span></a></td>
...
<!--Footer End Here -->
  ...
  <script language="JavaScript" type="text/javascript">
            function fnapprove(id) {
                ...
                var result = confirm("Are you sure to approve warranty claim form ?");
                //alert(id);
                if (result)
                {
                    // alert('sss');
