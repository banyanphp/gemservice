                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="widget-header">
                                       <h3 style="font-weight: 900;">Completed Complaint List</h3>
                                    ...
                                    <div class="data-align-right">
                                        <div class="tbl-action-toolbar">
                                            <ul>
                                                ...
                                                <a href="export_complete_complaints.php" class="btn btn-info " ><i class="zmdi zmdi-archive"></i> Export Excel</a>
                                               </ul>
                                        </div>
                                    </div>
                                </div>
...
$code=$_SESSION['emp_code'];
 $sql = "SELECT * FROM complaints_2017 where status='Completed' and date(comp_closing_date)>'$month' and ser_eng_code='$code' order by complaint_no ";
...
?>
                            <tr>
							 <td><?php echo $sl; ?></td>
                                ...
                                <td data-value="1"><a class="label label-info"  title="Active" href="javascript:void('0')">Completed</span></a></td>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="footer-right">
                    <span class="footer-meta">Crafted with&nbsp;<i class="fa fa-heart"></i>&nbsp;by&nbsp;<a href=""></a></span>
                </div>
            </div>
        </div>
    </div>
