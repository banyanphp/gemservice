...
<div class="widget-wrap">
    <div class="widget-header block-header clearfix">
        <div class="pull-left">
            <h3>Autocomplete</h3>
            <p>Autocomplete form elements</p>
        </div>
                    ...
                    <form action="#" class="j-forms" novalidate>
                        ...
                        <div class="form-content">
                            ...
                            <div class="unit">
                                ...
                                <div class="input">
                                    <input class="form-control" type="text" placeholder="Enter a letter" id="multi-list-autocomplete" name="multi-list-autocomplete">
                                </div>
                            </div>
