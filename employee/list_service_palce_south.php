...
$sl=0;
$sql = "SELECT * FROM service_engineers where zoneid = '1' order by zoneid";
  ...
  <script language="JavaScript" type="text/javascript">
            function fndelete(id) {
                ...
                if (result)
                {
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'delete_zone_place_south.php',
                        data: {
                            id: id,
                        },
		 ...
		 <script language="JavaScript" type="text/javascript">
            function update(id) {
                ...
                $.ajax({
                    type: "POST",
                    url: 'view_zone_place_service.php',
                    data: {
                        id: id,
                    },
                    success: function (data)
