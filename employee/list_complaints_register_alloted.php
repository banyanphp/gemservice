                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="widget-header">
                                                                  <h3 style="font-weight: 900;">Pending Complaints
</h3>
                                ...
                                <div class="col-md-6">
                                    <div class="data-align-right">
                                        <div class="tbl-action-toolbar">
                                            <ul>
                                             <a href="export_list_complaints_register_alloted.php" class="btn btn-info " ><i class="zmdi zmdi-archive"></i> Export Excel</a>
...
$team=$_SESSION['team'];
$sql = "SELECT * FROM complaints_2017 where  team in ($team) and service_engineer_allotment='Yes' and status='Pending'  order by complaint_no ";
$result = mysql_query($sql);
while($query = mysql_fetch_array($result)){
	$sl++;
$code=$query['ser_eng_code'];
$codename=mysql_fetch_array(mysql_query("select emp_name from employee where emp_code='$code'"));
?>
                            <tr>
							 <td><?php echo $sl; ?></td>
                                ...
                                <td><?php echo $query['complaint_date']; ?></td>
                                    <td><?php echo $codename['emp_name']; ?></td>
