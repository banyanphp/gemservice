...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-6">
            <h2>Colors Pickers</h2>
            <p>jQuery Spectrum Colorpickers</p>
        </div>
        <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <form action="#" class="j-forms" novalidate>
                        ...
                        <div class="form-content">
                            ...
                            <div class="w-section-header"><h3>Color format</h3></div>

                            <!-- start hex hsl -->
                            <!-- for proper colorpicker work -->
                            ...
                            <div class="j-row">
                                <div class="span6 unit">
                                    ...
                                    <label class="color-group" for="hex">
                                        <input class="form-control" type="text" id="hex">
                                    </label>
                                </div>
                                <div class="span6 unit">
                                    <label class="label">HSL</label>
                                    <label class="color-group" for="hsl">
                                        <input class="form-control" type="text" id="hsl">
                                    </label>
                                </div>
                            </div>
                            <!-- end hex hsl -->
                            ...
                            <div class="unit">
                                ...
                                <label class="color-group" for="rgb">
                                    <input class="form-control" type="text" id="rgb">
                                </label>
                            </div>
                            <!-- end rgb -->

                            <div class="w-section-header"><h3>Transperency</h3></div>
                            ...
                            <div class="j-row">
                                <div class="span6 unit">
                                    <label class="label">Alpha RGB</label>
                                    <label class="color-group" for="a-rgb">
                                        <input class="form-control" type="text" id="a-rgb">
                                    </label>
                                </div>
                                <div class="span6 unit">
                                    <label class="label">Alpha HSL</label>
                                    <label class="color-group" for="a-hsl">
                                        <input class="form-control" type="text" id="a-hsl">
                                    </label>
                                </div>
                            </div>
                            <!-- end transperency -->

                            <div class="w-section-header"><h3>Palette</h3></div>
                            ...
                            <div class="j-row">
                                <div class="span6 unit">
                                    ...
                                    <label class="color-group" for="palette1">
                                        <input class="form-control" type="text" id="palette1">
                                    </label>
                                </div>
                                <div class="span6 unit">
                                    <label class="label">Palette only</label>
                                    <label class="color-group" for="palette2">
                                        <input class="form-control" type="text" id="palette2">
                                    </label>
                                </div>
                            </div>
                            <!-- end palette -->
