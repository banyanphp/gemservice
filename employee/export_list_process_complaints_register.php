...
$sql = "SELECT * FROM complaints_2017 where  team!='' and service_engineer_allotment!='Yes'  order by complaint_no ";$result = mysql_query($sql);



header("Content-type: application/vnd-ms-excel");
// Defines the name of the export file "codelution-export.xls"
header("Content-Disposition: attachment; filename=Process complaints.xls");
?>
<style>
table>th{
